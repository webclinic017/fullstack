...
(function () {
    ...
    angular
        .module('fullstackApp')
        .controller('PandaLoginController', PandaLoginController);

    PandaLoginController.$inject = ['$scope', '$interval', '$timeout', '$window', '$state', 'account', 'validator', '$cookies'];

    function PandaLoginController($scope, $interval, $timeout, $window, $state, account, validator, $cookies) {
            ...
            account.login(para).then(function (data) {
                ...
                if (data.is_succ) {
                    ...
                    $timeout(function () {
                        ...
                        $window.location.href = '/panda/asset';
                    }, 100);
                } else {
                    layer.msg(data.message);
                }
