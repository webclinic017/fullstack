...
(function () {
    ...
    angular
        .module('fullstackApp')
        .controller('SettingInfoController', SettingInfoController);

    SettingInfoController.$inject = ['$scope', 'account', 'validator'];

    function SettingInfoController($scope, account, validator) {
        $scope.basicInfo = {
            username: undefined,
            feature: {
                key: undefined,
