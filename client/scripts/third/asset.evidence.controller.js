...
(function () {
    ...
    angular.module('fullstackApp')
        .controller('ThirdEvidenceController', ThirdEvidenceController);

    ThirdEvidenceController.$inject = ['$scope', 'asset', '$layer', 'previewImage'];

    function ThirdEvidenceController($scope, asset, $layer, previewImage) {
