...
(function () {
    ...
    angular.module('fullstackApp')
        .controller('ThirdCardController', ThirdCardController);

    ThirdCardController.$inject = ['$scope', 'config', '$state', '$modalInstance', 'validator', 'account', 'asset', 'passedScope'];

    function ThirdCardController($scope, config, $state, $modalInstance, validator, account, asset, passedScope) {
