module.exports = {
    thirdH5:{
        ...
        enterNumPassword:{
            ...
            "zh-Hant":"請輸入帳號和密碼",
            id:"SIlahkan masukkan nomor akun dan kata sandi anda."
        },
        addSuccess:{
            zh:"添加成功",
            en:"Successful",
        ...
        bindAccountBind:{
            ...
            id:"Daftarkan rekening bank anda,TigerWit tidak mendukung penarikan ke Kartu Kredit."
        },
        bankAccount:{
            zh:"银行账户",
            en:"Bank account",
        ...
        applicationPayment:{
            ...
            "zh-Hant":"出金申請已提交",
            id:"Permohonan aplikasi telah terkirim."
        },
        twoWorkingDays:{
            zh:"我们会在两个工作日内处理完毕",
            ...
            id:"Pengajuan aplikasi akan diproses dalam 2 hari kerja."
        },
        copySuccess:{
            zh:"复制成功",
            en:"Follow success",
        ...
        precautionsTip3:{
            zh:"如有其它疑问，请联系客服：",
            en:"If you have any other questions, please contact customer support: ",
            vi:"Nếu bạn có bất kì câu hỏi nào, vui lòng liên hệ với phòng chăm sóc khách hàng của để được hỗ trợ: ",
            "zh-Hant":"如有其它疑問，請聯系客服：",
            id:"Apabila anda memiliki pertanyaan, silahkan hubungi layanan pelanggan: "
        },
        ...
        wait10Min:{
            zh:"到账约为10分钟，请耐心等待",
            en:"Will arrive account about 10 minutes. Please wait patiently",
            vi:"Sẽ đến tài khoản khoảng 10 phút. Xin hãy kiên nhẫn chờ đợi",
            "zh-Hant":"到帳約為10分鐘，請耐心等待",
