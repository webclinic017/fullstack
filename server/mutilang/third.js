module.exports = {
    ...
    third_index1:{
        ...
        vi:"Khi mở một tài khoản, bạn sẽ nhận",
        "zh-Hant":"開戶就送",
        id:"Begitu anda membuka aku, anda akan mendapatkan"
    },
    third_index2:{
        zh:"$10000体验金 轻松玩外汇",
        en:"$10000 experience money to help you play good at foreign exchange.",
        vi:"10000 USD trong tài khoản trải nghiệm để giúp bạn giao dịch tốt trong thị trường ngoại hối",
        "zh-Hant":"$10000體驗金 輕松玩外匯",
        id:"Dana pengalaman sebesar 10,000$ untuk membantu anda bertransaksi dengan baik di valuta asing"
    },
    third_index3:{
        zh:"新手豪礼",
        en:"Luxury gift for beginner",
        vi:"Món quà lớn cho người bắt đầu",
        "zh-Hant":"新手豪禮",
        id:"Hadiah Mewah untuk para pemula"
    },
    third_index4:{
        zh:"多重红包豪礼等你拿",
        en:"Multiple coupons as gifts just for beginners",
        vi:"Nhiều phần quà là các loại điểm thưởng chỉ dành cho người mới bắt đầu",
        "zh-Hant":"多重紅包豪禮等妳拿",
        id:"Berbagai kupon diberikan sebagai hadiah kepada para pemula"
    },
    third_index5:{
        zh:"立即开户",
        en:"Open an account immediately",
        vi:"Mở một tài khoản ngay lập tức",
        "zh-Hant":"立即開戶",
        id:"Buka akun sekarang juga"
    },
    third_index6:{
        zh:"开户前请准备好在有效期内的身份证件",
        en:"Please prepare the valid identity card before opening an account",
        vi:"Xin chuẩn bị thẻ chứng minh còn hiệu lực trước khi mở một tài khoản",
        "zh-Hant":"開戶前請準備好在有效期內的身份證件",
        id:"Mohon siapkan identitas yang valid sebelum membuka kaun"
    },
    third_placeholder1:{
        zh:"请输入真实姓名",
        en:"Please fill in your full name",
        vi:"Xin điền vào tên đầy đủ của bạn",
        "zh-Hant":"請輸入真實姓名",
        id:"Silahkan isi nama lengkap anda"
    },
    third_placeholder2:{
        zh:"请输入身份证号",
        en:"Please fill in your ID number",
        vi:"Xin điền vào số chứng minh thư của bạn",
        "zh-Hant":"請輸入身份證號",
        id:"Silahkan isi nomor ID anda"
    },
    third_placeholder3:{
        zh:"请输入您的邮箱，有助于接收重要的提醒消息",
        en:"Email",
        vi:"Email",
        "zh-Hant":"請輸入您的郵箱，有助於接收重要的提醒消息",
        id:"Email"
    },
    third_placeholder4:{
        zh:"请选择国家/地区",
        en:"Select Country/Region",
        vi:"Chọn Quốc gia/Vùng",
        "zh-Hant":"請選擇國家/地區",
    ...
    third_username1:{
        ...
        vi:"Do của các quy định quản lý, xin đảm bảo rằng các thông tin cá nhân mà bạn cung cấp là chính xác và không gian lận.",
        "zh-Hant":"因監管要求，請您提供相關信息。請確認是您本人，審核通過後不可修改",
        id:"Sesuai dengan persyaratan peraturan, harap pastikan bahwa anda telah mengisi data pribadi yang benar dan tidak curang"
    },
    third_username2:{
        zh:"男",
        en:"Male",
    ...
    third_username5:{
        ...
        vi:"Chọn loại chứng nhận",
        "zh-Hant":"證件類型",
        id:"Pilih tipe dokumen"
    },
    third_username6:{
        zh:"请输入证件号码",
        en:"Enter ID No.",
        vi:"Nhập số Chứng minh thư.",
        "zh-Hant":"請輸入證件號碼",
        id:"Masukkan nomor ID"
    },
    third_username7:{
        zh:"请选择您的出生日期",
    ...
    third_uploadCardTip:{
        ...
        vi:"Vui lòng tải lên hộ chiếu của bạn",
        "zh-Hant":"點擊上傳身份證照片（正面）",
        id:"Silahkan unggah paspor anda"
    },
    third_verify1:{
        zh:"认证信息已提交",
        en:"Submitted",
    ...
    third_verify1_1:{
        ...
        vi:"Chúng tôi đang xử lý đơn đăng kí của bạn",
        "zh-Hant":"正在審核中",
        id:"Kami saat ini sedang meninjau permohonan anda"
    },
    third_verify2:{
        zh:"审核时间：",
        en:"Audit Time: ",
        vi:"Thời gian Kiểm toán",
        "zh-Hant":"審核時間：",
    ...
    third_verify6:{
        ...
        vi:"Xin lưu ý kiểm tra tình trạng đơn đăng kí của bạn.",
        "zh-Hant":"請留意查詢您的審核狀態。",
        id:"Mohon selalu periksa status aplikasi anda"
    },
    third_cardEgTitle:{
        zh:"拍摄示例",
