module.exports = {
    ...
    newhome_2:{
        ...
        id:"Buka akun dalam hitungan menit, online atau lewat aplikasi dan langsung bertransaksi."
    },
    newhome_4:{
        zh:"外汇",
        en:"FX",
    ...
    newhome_10:{
        ...
        vi:"Tự giao dịch và sao chép giao dịch",
        "zh-Hant":"復制跟單",
    ...
    newhome_18:{
        ...
        vi:"Mức đòn bẩy linh hoạt",
        "zh-Hant":"杠桿靈活",
        id:"Daya ungkit yang fleksibel"
    },
    newhome_20:{
        zh:"可选择50/100/200倍杠杆",
    ...
    newhome_21:{
        ...
        vi:"Kí quỹ tối thiểu USD50",
        "zh-Hant":"最低$50即可入金",
        id:"Minimal deposit 50 $"
    },
    newhome_22:{
        zh:"开户仅需$50",
    ...
    newhome_23:{
        ...
        "zh-Hant":" ",
        id:"Deposit pertama mulai dari 50 USD"
    },
    newhome_24:{
        zh:"最低交易手数0.01手",
        ...
        "zh-Hant":"最低交易手數0.01手",
        id:"Transaksi mulai dari 0,01 Lot"
    },
    newhome_25:{
        zh:"外汇，贵金属，原油，差价合约等",
        en:"FX, precious metals, commodities",
        vi:"FX, kim loại quý, hàng hóa và chỉ số",
        "zh-Hant":"外匯，貴金屬，原油，差價合約等",
        id:"Valas, Logam Mulia, Komoditas, "
    },
    newhome_26:{
        zh:" ",
        en:"and indices",
    ...
    newhome_27:{
        ...
        vi:"Giá trị lệnh tối thiểu thấp",
        "zh-Hant":"交易成本低",
        id:"Transaksi dengan lot yang kecil"
    },
    newhome_28:{
        zh:"交易品种多样",
        en:"Multiple product options",
        vi:"Nhiều lựa chọn sản phẩm",
        "zh-Hant":"交易品種多樣",
        id:"Berbagai pilihan produk"
    },
    newhome_29:{
        zh:"了解更多",
        en:"Find out more",
    ...
    newhome_33:{
        ...
        vi:"Trên một ứng dụng đẹp hơn, thông minh, trực quan hơn.",
    ...
    newhome_34:{
        ...
        vi:"Nhanh nhạy, tinh tế nhưng dễ sử dụng.",
        "zh-Hant":"操作靈活，功能豐富",
    ...
    newhome_35:{
        ...
        vi:"Được xây dựng có sẵn xung quanh bạn. Cá nhân hoá theo nhu cầu của bạn.",
        "zh-Hant":"為交易者量身設計。",
        id:"Dibuat untuk memenuhi kebutuhan anda."
    },
    newhome_35_1:{
        zh:"现在立刻下载APP，",
    ...
    newhome_35_2:{
        ...
        vi:"Mở tài khoản Thực trong vòng vài phút.",
        "zh-Hant":"即可享受10000美元賬戶體驗金。",
        id:"Buka akun Live dalam hitungan menit."
    },
    newhome_36:{
        zh:"值得信赖",
        en:"Reliable and trustworthy",
        vi:"UY TÍN VÀ ĐÁNG TIN CẬY",
        "zh-Hant":"值得信賴",
    ...
    newhome_37_1:{
        ...
        vi:"Được bảo mật bởi blockchain",
        "zh-Hant":"區塊鏈技術保護",
        id:"Dilindungi oleh blockchain"
    },
    newhome_37_2:{
    ...
    newhome_37:{
        ...
        vi:"Bảo vệ khách hàng",
        "zh-Hant":"用戶保護",
        id:"Perlindungan Klien"
    },
    newhome_38:{
    ...
    newhome_39:{
        ...
        vi:"Phòng tránh trường hợp tài khoản bị âm.",
        "zh-Hant":"賬戶負值保護",
        id:"Perlindungan Saldo Negatif"
    },
    newhome_40:{
        zh:"当你在TigerWit交易时，你将受账户负值政策保护。这意味着即使你的交易表现不佳，你也不会欠TigerWit任何钱。你的损失不会超过你的账户总额。",
        ...
        vi:"Khi bạn giao dịch với TigerWit, bạn được bảo vệ bởi chính sách Phòng tránh trường hợp tài khoản bị âm của chúng tôi. Điều này có nghĩa là ngay cả khi hiệu suất giao dịch của bạn không thành công, bạn sẽ không bao giờ nợ bất kỳ khoản tiền nào của TigerWit. Bạn không thể mất nhiều hơn số vốn chủ sở hữu tài khoản của mình.",
        "zh-Hant":"當妳在TigerWit交易時，妳將受賬戶負值政策保護。這意味著即使妳的交易表現不佳，妳也不會欠TigerWit任何錢。妳的損失不會超過妳的賬戶總額。",
        id:"Ketika anda melakukan transaksi di TigerWit, anda dilindungi oleh kebijakan Perlindungan Saldo Negatif. Artinya, apabila saldo akun anda mengalami minus anda tidak akan pernah berhutang kepada TigerWit. Anda tidak akan kehilangan uang lebih dari saldo yang ada di akun anda."
    },
    newhome_41:{
        zh:"用户资金仅用于交易。",
        en:"All client funds are stored in a segregated trust account.",
        vi:"Tất cả các quỹ của khách hàng được lưu trữ trong một tài khoản ủy thác tách biệt.",
        "zh-Hant":"用戶資金僅用於交易。",
        id:"Semua dana dari klien dimasukkan ke rekening yang terpisah."
    },
    newhome_42:{
        zh:"更多用户的选择",
        en:"Trading with TigerWit",
        vi:"Giao dịch với TigerWit",
        "zh-Hant":"更多用戶的選擇",
        id:"Transaksi bersama TigerWit"
    },
    newhome_42_1:{
        zh:"TigerWit提供全球交易量最大、最具流动性的市场。",
    ...
    newhome_43:{
        ...
        id:"Buka akun - Online atau lewat aplikasi "
    },
    newhome_44:{
