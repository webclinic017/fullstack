...
module.exports = {
    ...
    */
    ...
    products : [
        {
            id : "9",
            name : "【派克道森201701-02-V9】",    //产品标题
            money_copy : "$2000-$50000",   //复制金额   exam:'$10000'
            money_copy_low : 2000,          // money_copy 的最低复制金
            money_copy_high : 50000,          // money_copy 的最高复制金
            money_copy_max : "$40万", //最高复制金额 exam : '$4000'
            period : "5个交易日",      //复制封闭期
            withdraw_history : "30%",    //历史最高回撤
            profit_rate_wish : "50%",  //预期年化收益率
            profit_rate_now : "", //实时年化收益率
            start_date_appoint: "2016.12.31 20:00:00", //预约开始时间 exam:'2016.5.17'
            end_date_appoint : "2017.01.01 20:00:00",  //预约结束时间 exam:'2016.5.17'
            start_date_trade : "2017.01.02 00:00:00",  //开始交易时间 exam:'2016.5.17'
            ...
            //Optional
            end_date_trade : "2017.01.07 00:00"  //结束交易时间  exam : '2016.5.19'
        },
        {
            id : "8",
            name : "【派克道森201612-26-V8】",    //产品标题
            money_copy : "$2000-$30000",   //复制金额   exam:'$10000'
            money_copy_low : 2000,          // money_copy 的最低复制金
            ...
            profit_rate_now : "", //实时年化收益率
            start_date_appoint: "2016.12.24 20:00", //预约开始时间 exam:'2016.5.17'
            end_date_appoint : "2016.12.25 20:00",  //预约结束时间 exam:'2016.5.17'
            start_date_trade : "2016.12.26 00:00",  //开始交易时间 exam:'2016.5.17'
            progress : "100", //投资进度 exam:50
            jiafang:"派克道森", //甲方，操盘手，出现在agree里
            team_intro : "team_pkds", //文件名，团队介绍模块
            desc_risk : "动用杠杆不超过100倍，亏损达到账户初始资金的50%时，停止交易.", //风险控制
            ...
            note : "交易员主要交易货币英镑兑美元（GBPUSD）", //备注            
            //Optional
            end_date_trade : "2016.12.31 00:00"  //结束交易时间  exam : '2016.5.19'
        },
        {
            id : "7",
