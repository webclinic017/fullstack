...
module.exports = function () {
    ...
    var data = {
        ...
        "forex1": { "en": "The Foreign Exchange Market is one of the world's largest single market. In 2013, trading volumes reached $5.3 trillion dollars. Foreign exchange rate is mainly affected by international trade, national economy and the policy and influence of investment flows. As a result, the foreign exchange market information is more transparent, liquidity is better and there are more fair prices. Transaction can be maked in two directions, buy and sell, and in all 24 hours of weekday. All the above advantages make Foreign Exchange Transaction deeply affected by large investment institutions and investors.", "zh": "外汇市场是全球最大的单一产品市场，自2013年起每天拥有超过5.3万亿美元的成交额，交易内容为两种货币之间汇率差价。由于外汇汇率主要受国际间的交易、各国经济和政策以及投资流向的影响，所以外汇交易市场的信息更透明，流通性更好，价格更公平。其具有5天24小时双向交易等特点，深受大型投资机构和投资者的喜爱。" },
        ...
        "forex7": { "en": "We provide three different kinds of leverage, 50 times, 100 times, 200 times, which makes more flexible to meet you for risk control and cash management requirements..", "zh": "我们同时提供 50 倍，100 倍，200 倍三种不同的杠杆，更灵活的满足您对于风险把控，资金管理的需求。" },
        ...
        "oil1": { "en": "Crude oil, also known as 'black gold' is the main raw material in fuel and gasoline. Fuel and gasoline is one of the most important primary energy sources in the world. At present, the oil is not only the largest in the global trade of goods, it is one of the most important trading global financial asset.", "zh": "原油即石油，也称“黑色金子”，原油是燃油和汽油的主要原材料，是世界上最重要的一次能源之一。目前，原油不仅成为全球贸易中最大宗的商品，同时也是全球金融资产中最重要的交易标的物之一。" },
        ...
        "metal1": { "en": "Gold and silver, as the oldest and most traditional metals in civilization are the most recognized currency symbol. They belong to the traditional safe-haven assets and with the progress of science and technology occupies an important position in industrial market and also represents a safe commodity.", "zh": "黄金和白银作为人类文明最古老、最传统、最被广泛认可的货币符号，属于传统的避险资产，随着科技的进步，其在工业生产中占据了重要的地位，同时具有避险兼商品的属性。" },
