...
module.exports = function () {
    ...
    var data = {
        ...
        "home45": { "en": "Efficient,safe and secure ", "zh": "出入金高效、安全、稳妥" },
        ...
        "home67": { "en": "The above data real-time automatic updates,Saturday and Sunday without price", "zh": "数据实时自动更新，周六日停盘无报价" },
        ...
        "forex4": { "en": "" + companyConfig.companyNameEn + "keeps a close watch on global markets through STP. With simple, quick, efficient and safe cash depositing and withdrawal mode, " + companyConfig.companyNameEn + " renders services of all major currency pairs and cross currency pairs. With the provision of more flexible, transparent and competitive foreign exchange agreement, " + companyConfig.companyNameEn + " also provides a creative order following mode and serves as a bond to link investment masters and common investors.", "zh": "" + companyConfig.companyNameZh + "采用STP直通式交易，密切关注全球市场。出入金模式简单、快捷、高效、安全，涵盖所有主流货币对及交叉货币对。我们提供更灵活、更透明、更具竞争力的外汇合约，同时您还可以享受到" + companyConfig.companyNameZh + "所提供的创新性的跟单交易模式，是连接高手和普通投资者的纽带。" },
        ...
        "metal14": { "en": "" + companyConfig.companyNameEn + " has adopted an extensively used and mature MT4 platform in the world and launched intelligent trading module, closely following the trend of the world financial market.", "zh": "" + companyConfig.companyNameZh + "采用全球广泛使用的成熟的MT4平台，开会智能交易模块，紧跟世界金融市场潮流。" },
