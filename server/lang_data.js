...
module.exports = function () {
    ...
    var data = {
        ...
        "wad8": { "en": "We will respond to your withdraw application within one working day. Due to different transfer time from different banks, it shall be subject to a specific transfer time.", "zh": "A：我们会在一个工作日内响应您的取款申请。不同银行到账时间略有不同，请以具体到账时间为准。" },
        "wad9": { "en": "What should I prepare if I need to withdraw?", "zh": "Q：如果我想从交易账户中取款需要做些什么？" },
        "wad10": { "en": "Quite simple. What you need to do is just logging into the personal center on our website, making application for withdrawal and entering your bank card information, then our client service staff will help you to finish it.", "zh": "A：非常简单。 您只需要登录我们的网站个人中心提出提款请求，输入您本人的银行卡信息即可，我们的客服人员会协助您处理。" },
        "wad11": { "en": "Attention: we do not receive deposits and withdrawals from any third party, please use your own bank card during withdrawal.", "zh": "请注意：我们不接受任何第三方出入金，请务必使用本人银行卡办理取款。" },
        ...
        "wad17": { "en": "Why haven’t I received the withdrawn amount while the funds in the transaction account is displayed removal?", "zh": "Q：交易账户中的资金已显示移除，为什么我还没有收到出金金额？" },
        "wad18": { "en": "Withdrawal application has been approved successfully. Please keep close eyes on(closely monitor) your receiving bank and ensure that the funds are transferred.", "zh": "A：出金申请金额已被成功批准。请密切关注您的收款银行确认资金。" },
        ...
        "deal40": { "en": "In case of drastic market fluctuations, the price will change dramatically. In this case, we need to supply new market prices to you. Under this circumstance, you can accept new price or refuse it and cancel the deal. The other reason for price re-quotation might be slow internet connection or connection fault, which slows down the transmission of deals; It means that the price you saw on the platform is the old price not the current market price.", "zh": "A：如果出现大幅的市场波动，价格会急剧变化。在此情况之下，我们需要向您提供新的最新市场价。在此情况下，您可以接受新的重新报价或者拒绝新的价格并取消交易的执行。取得重新报价的另一个可能的原因在于因特网连接缓慢或出现故障，延迟了订单传输；意味着您在交易平台上看到的是以前的价格而非当前市场价格。" },
        ...
        "swap11": { "en": "* If the business day is public holiday,the swap rate is calculated from the day before this public holiday.", "zh": "如交易日当天为公共节假日，隔夜利息将推前一天计算" },
