...
module.exports = function () {
    var data = {
        ...
        "forex12": {"en": "Through cooperation with many top banks and financial institutions in the industry, " + companyConfig.companyNameEn + " directly obtains the optimal quotation of more than 20 banks to clients through ECN mode, such as Morgan, Citibank, BAC and Buckley. ", "zh": "" + companyConfig.companyNameZh + "与业内顶级银行及金融机构合作，采取 ECN 模式直接获取多达 20 多家银行如摩根，花旗，美银，巴克利等等国际巨头见最优报价提供给尊敬的客户。"},
        ...
        "metal6": {"en": "" + companyConfig.companyNameEn + " offers three kinds of leverage for flexible option and the leverage of spot silver is as high as 150 times.", "zh": "" + companyConfig.companyNameZh + "提供三种杠杆灵活选择，现货白银杠杆可高达 150 倍以上。"},
