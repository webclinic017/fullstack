...
module.exports = function () {
    ...
    var data = {
        ...
        "foot12": { "en": "High risk warning: There are risks in the market, investors should be cautious. Margined transactions in financial market are full of risks and not suitable for every investor. Increasing leverages implys the coexistence of high risks and profits. Before users decide to trade, it is of necessity for you to make investment goals, evaluate your investment experiences and ability to tolerant the possible risks in order to select suitable investment modes; users should be aware that there might be entire or partial losses of their margined transactions in financial market. " + companyConfig.companyNameEn + " transaction platform provides trade masters and beginners with copy trading services. The information posted in websites, including real-time transaction notifications, investment articles and other resources derives from the internet and all investors have to consider and weigh the risks and safety in their investment. The historical transaction data of trade masters does not stand for their capacity in prospective trading, thus, users have to take all the possible risks on their own.", "zh": "高风险投资警告：市场有风险，投资需谨慎。金融市场的保证金交易存在较高风险，不适合所有投资者，增大杠杆意味着高风险与高收益并存。在您决定交易前，应当谨慎考虑您的投资目标、投资经验及风险承受能力，并选择适合自己的投资方式；您需要知晓金融市场的保证金交易具有全部或部分亏损的可能。" + companyConfig.companyNameZh + "交易平台为广大交易高手及普通投资者提供复制交易服务，网站发布的任何信息，包括实时交易提醒、投资文章及其他资源等均来自互联网所有用户需仔细考量并权衡投资风险及安全性。交易高手的历史交易数据不代表未来操作能力，用户因此所产生的任何风险需自己承担。" },
        ...
        "home17": { "en": "Enjoy the same strategic trading of masters.", "zh": "享受高手同策略交易" },
        "home18": { "en": "Be a master, win 20% of followers' profit.", "zh": "成为高手，您将获得复制者盈利的20%" },
        "home19": { "en": "Diverse trading products", "zh": "多样化的交易产品" },
        ...
        "home26": { "en": "One account can trade gold and silver meanwhile", "zh": "一个账户可同时交易黄金、白银" },
        ...
        "home30": { "en": "Include mainstream CFDs, such as US30, USA500, NAS100, JPN225, EUSTX50 and etc.", "zh": "包含三大美指、日经、欧洲优选等主流股指" },
        "home31": { "en": "Margin that is as low as 2% is provided", "zh": "提供低至2%的保证金水平" },
        "home32": { "en": "Low threshold and transparent quotation", "zh": "门槛较低，报价透明" },
        "home33": { "en": "STP (Straight Trade Process)", "zh": "STP直通式交易模式" },
        "home34": { "en": "Provide excellent trading experience and protection in term of optimizing the value of users.", "zh": "为出色的交易体验和优化用户价值提供保障" },
        "home35": { "en": companyConfig.companyNameEn + " cooperates with a number of well-known institutions, including Bank of America, Citigroup, JPMorgan Chase, Barclays, Macquarie Bank, etc. and obtain forex quotations and liquidation through these international banks. The STP of " + companyConfig.companyNameEn + " enables the orders of user to access international bank market, so that users could place their orders in the shortest possible time and the best price.", "zh": "" + companyConfig.companyNameZh + "与多家知名机构合作，包括美国银行，花旗，摩根大通，巴克莱，麦格理银行等，从多家国际银行获得外汇报价和清算，并且通过STP的方式将用户的订单传输到国际间银行市场，从而让用户订单在最短的时间内以最优的价格成交。" },
        ...
        "home39": { "en": "Dealing in milliseconds, high stability and safety ensure an exceptional trading experience", "zh": "毫秒交易速度，稳定安全，保障顶级交易体验" },
        ...
        "home45": { "en": "The process time of deposit and withdrawal is 2 times as fast as that of the average time in the industry", "zh": "入金即到账，出金领先行业均速2倍" },
