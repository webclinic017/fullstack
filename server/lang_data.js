...
module.exports = function () {
    ...
    var data = {
        ...
        "forex1": { "en": "The Foreign Exchange Market is one of the world's largest single markets. In 2013, trading volumes reached $5.3 trillion dollars. Foreign exchange rate is mainly affected by international trade, national economy and the policy and influence of investment flows. As a result, the foreign exchange market information is more transparent, liquidity is better and there are more fair prices. Transaction can be made in two directions, Buy and sell transactions can be made 24 hours on weekdays. All the above advantages make Foreign Exchange Transaction deeply affected by large investment institutions and investors.", "zh": "外汇市场是全球最大的单一产品市场，自2013年起每天拥有超过5.3万亿美元的成交额，交易内容为两种货币之间汇率差价。由于外汇汇率主要受国际间的交易、各国经济和政策以及投资流向的影响，所以外汇交易市场的信息更透明，流通性更好，价格更公平。其具有5天24小时双向交易等特点，深受大型投资机构和投资者的喜爱。" },
        ...
        "forex4": { "en": "" + companyConfig.companyNameEn + "keeps a close watch on global markets through STP. With simple, quick, efficient and safe cash depositing and withdrawal mode, " + companyConfig.companyNameEn + " renders services of all major currency pairs and cross currency pairs. With the provision of more flexible, transparent and competitive foreign exchange agreement, " + companyConfig.companyNameEn + " also provides a creative order following mode and serves as a bond to link investment masters and common investors.", "zh": "" + companyConfig.companyNameZh + "，采用STP直通式交易，紧盯全球市场。简单快捷高效安全的出入金方式，涵盖所有主流货币对及交叉货币对。我们提供更灵活，更透明，更具竞争力的外汇合约，同时您还可以享受到" + companyConfig.companyNameZh + "最具创新性的跟单交易模式，是连结高手和普通投资者纽带。" },
        ...
        "forex12": { "en": "With " + companyConfig.companyNameEn + "’s STP process, " + companyConfig.companyNameEn + " obtains optimal quotation of more than 20 banks to clients such as JP Morgan, Citibank, BAC and Buckley.", "zh": "" + companyConfig.companyNameZh + "与业内顶级银行及金融机构合作，采取 STP 模式直接获取多达 20 多家银行如摩根，花旗，美银，巴克莱等等国际巨头见最优报价提供给尊敬的客户。" },
        ...
        "metal14": { "en": "" + companyConfig.companyNameEn + " has adopted an extensively used and mature MT4 platform in the world and launched intelligent trading module, closely following the trend of the world financial market.", "zh": "" + companyConfig.companyNameZh + "采用全球使用最广泛的成熟的 MT4 平台，开放智能交易模块，紧贴世界金融市场潮流。" },
        ...
        "cfd13": { "en": "" + companyConfig.companyNameEn + " provides quotation of top banks, thus helping investors achieve price discovering.", "zh": "" + companyConfig.companyNameZh + "提供来自于顶级银行的第一手数据报价，帮助投资者进行价格发现。" },
        "cfd14": { "en": "Follow masters' move", "zh": "复制跟单交易" },
        "cfd15": { "en": "" + companyConfig.companyNameEn + " provides advanced and creative full-automatic order following stigeystem and gathers numerous investment masters with great profit making capabilities. The investors have the ability to gain the earnings of the same proportion with the masters through following them. Masters can also gain more earnings through increasing their followers continuously.", "zh": "" + companyConfig.companyNameZh + "提供业内最先进，最具创新性的全自动复制跟单系统，并且汇聚众多颇具盈利能力的投资高手，投资者可通过复制高手交易获得同比例投资收益。高手也可通过不断增加跟随者而获得更多收益。" },
        ...
        "stp2": { "en": "In STP (straight through processing), user’s orders are transmitted via the liquidity provider to an international bank seeking to obtain the optimal transaction price and approximate real time trading.", "zh": "STP（straight through processing ），是指用户的订单通过交易客户端传达到国际间银行，并且获得最优成交价的模式，即客户的下单发送到银行，按最接近银行的价位进行即时交易。" },
        ...
        "stp4": { "en": companyConfig.companyNameEn +" obtains foreign exchange quotation and settlement from several famous institutions including Barclays Bank, Macquaire Bank, Deutsche Bank, JP Morgan Chase & Co and Bank of America thorugh cooperation with its liquidity provider. " + companyConfig.companyNameEn + " transmits the user’s order via its liquidity provider to the international bank market through STP, facilitating the user’s ability to conclude a deal with the optimal price for their order in the shortest time.", "zh": "" + companyConfig.companyNameZh + "与多家知名机构合作，从巴克莱银行，麦格理银行，德意志银行，摩根大通，花旗银行，美国银行等获得外汇报价和清算，并且通过STP的方式将用户的订单传输到国际间银行市场，从而让用户订单在最短的时间内以最优的价格成交。" },
