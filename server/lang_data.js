...
module.exports = function () {
    var data = {
        ...
        "home51": {"en": "Register during Sep 1st to Sep 30th, chance to get Mi Band!", "zh":"2016.9.1到2016.9.30注册 有机会得小米手环哦"},
        ...
        "home55": {"en": "Happy hour: Sep 1st to Sep 30th", "zh":"活动时间：2016.9.1至2016.9.30"},
        ...
        "forex3": {"en": "Why to trade foreign exchange in TigerWit?", "zh": "为什么在老虎外汇交易外汇"},
        "forex4": {"en": "TigerWit keeps a close watch on global market through STP. With simple, quick, efficient and safe cash depositing and withdraw mode, TigerWit renders services of all major currency pairs and cross currency pairs. With the provision of more flexible, transparent and competitive foreign exchange agreement, TigerWit also provides the most creative order following mode and serves as a bond to link investment masters and common investors. ", "zh": "老虎外汇，采用STP直通式交易，紧盯全球市场。简单快捷高效安全的出入金方式，涵盖所有主流货币对及交叉货币对。我们提供更灵活，更透明，更具竞争力的外汇合约，同时您还可以享受到老虎外汇最具创新性的跟单交易模式，是连结高手和普通投资者纽带。"},
        "forex5": {"en": "TigerWit's advantages in foreign exchange trading", "zh": "在老虎外汇交易外汇的优势"},
        ...
        "forex10": {"en": "TigerWit provides the most advanced and most creative full-automatic order following system and gathers numerous investment masters with great profit-making capabilities. The investors can gain the earnings of the same proportion with the masters through following them. Masters can also gain more earnings through increasing their followers continuously.", "zh": "老虎外汇提供业内最先进，最具创新性的全自动复制跟单系统，并且汇聚众多颇具盈利能力的投资高手，投资者可通过复制高手交易获得同比例投资收益。高手也可通过不断增加跟随者而获得更多收益。"},
        "forex11": {"en": "Market ECN straight quotation service", "zh": "市场 ECN 直通式报价服务"},
        "forex12": {"en": "Through cooperation with many top banks and financial institutions in the industry, TigerWit directly obtains the optimal quotation of more than 20 banks to clients through ECN mode, such as Morgan, Citibank, BAC and Buckley. ", "zh": "老虎外汇与业内顶级银行及金融机构合作，采取 ECN 模式直接获取多达 20 多家银行如摩根，花旗，美银，巴克利等等国际巨头见最优报价提供给尊敬的客户。"},
        "forex13": {"en": "Trading time", "zh": "交易时间段"},
        "forex14": {"en": "TigerWit offers global trading and also provides financial services for clients continuously except the necessary inter-bank maintenance period per day.", "zh": "老虎外汇提供全球交易，除去每日必要的银行间维护时段，不间断的为我们的客户提供金融服务。"},
        "forex15": {"en": "How to achieve foreign exchange trade in TigerWit?", "zh": "在老虎外汇怎么做外汇交易?"},
        "forex16": {"en": "An investor of TigerWit sold one lot (eur/usd) around 10:00 on October 22, platform time of TigerWit at the position of 1.13450 by USD1000. ", "zh": "某位老虎外汇的投资者在老虎外汇的平台时间 10 月 22 号 10 点左右，于 1.13450 位置左右动用 1000 美金卖出 1 手欧美（eur/usd）。"},
        ...
        "forex20": {"en": "Introduction to TigerWit currency pairs", "zh": "老虎外汇货币对介绍"},
        ...
        "forex36": {"en": "TigerWit also provides the trading products of cross currency pairs of the above major currency pairs.", "zh": "老虎外汇同时提供以上主流货币对的交叉货币对交易产品"},
        ...
        "oil2": {"en": "Why to trade crude oil in TigerWit?", "zh": "为什么在老虎外汇原油交易"},
        "oil3": {"en": "In addition to Brent crude oil and West Texas crude oil, both of which sees the largest trading volume in the world, TigerWit also provides US natural gas contracts. TigerWit wholeheartedly provides the clients with the most flexible leverage, the most competitive point difference advantages and also obtains the most direct quotation data sources from world-leading banks in the financial sector. Meanwhile, it also renders the most innovative order following system.", "zh": "老虎外汇除了提供两大全球交易量最大的原油：布伦特原油和西德州原油合约以外，同时提供美国天然气合约。老虎外汇竭诚为客户提供最灵活的杠杆，最具竞争性的点差优势，来源于全球金融界顶级银行的最直接的报价数据源。同时也提供最具创新性的跟单系统服务。"},
        "oil4": {"en": "Advantages of TigerWit in crude oil trading", "zh": "在老虎外汇做原油交易的优势"},
        ...
        "oil17": {"en": "How to achieve crude oil trade in TigerWit?", "zh": "在老虎外汇怎么做原油交易？"},
        "oil18": {"en": "An investor of TigerWit sold one lot of West Texas crude oil (xti/usd) around 15:00 on October 23, platform time of TigerWit at the position of 45.890 by USD 1000.", "zh": "某位老虎外汇的投资者在老虎外汇的平台时间 10 月 23 号 15 点左右，于 45.890位置左右动用 1000 美金卖出 1 手西德州原油（xti/usd）。"},
        ...
        "oil22": {"en": "Introduction to TigerWit energy products", "zh": "老虎外汇能源类交易产品介绍"},
        ...
        "metal4": {"en": "TigerWit's advantages in foreign exchange trading", "zh": "在老虎外汇交易黄金、白银的优势"},
        "metal5": {"en": "High leverage", "zh": "杠杆高"},
        "metal6": {"en": "TigerWit offers three kinds of leverage for flexible option and the leverage of spot silver is as high as 150 times.", "zh": "老虎外汇提供三种杠杆灵活选择，现货白银杠杆可高达 150 倍以上。"},
        "metal7": {"en": "Low trading cost", "zh": "交易成本低"},
        "metal8": {"en": "The cost of trading spot silver in TigerWit is as low as USD 200 /155 kg, equivalent to RMB 7.5 /kg. ", "zh": "老虎外汇交易现货白银成本低至约 200 美元/155 kg，约 7.5 人民币/千克。"},
        "metal9": {"en": "Low threshold", "zh": "门槛较低"},
        "metal10": {"en": "RMB 300 margin will be needed for spot silver trading in China, while the minimum trading margin for spot silver trading in TigerWit is as low as USD 10. ", "zh": "国内现货白银交易动用保证金为约为 300 人民币，而老虎外汇现货白银交易最小交易保证金仅为 10 美金。"},
        "metal11": {"en": "Achieve gold and silver trading by one account", "zh": "一个帐户交易黄金、白银"},
        "metal12": {"en": "Given the restrictions of China's national conditions, most domestic exchanges can only trade spot silver but fail to trade gold. However, gold products fall into the trade category of greater importance in the international market. Given such situations, TigerWit can provide both silver and gold trading, rendering more independent choices for investors.", "zh": "由于国内相关国情限制，国内大多数交易所仅能交易现货白银，而无法交易现货黄金，但黄金产品是国际市场上更为关注与重要的交易品种，而老虎外汇同时提供白银与黄金交易，给广大投资者更为自主的选择。"},
        "metal13": {"en": "Trading by MT4", "zh": "使用 MT4 交易"},
        "metal14": {"en": "TigerWit has adopted the most extensively used and mature MT4 platform in the world and launched intelligent trading module, closely following the trend of world financial market.", "zh": "老虎外汇采用全球使用最广泛的成熟的 MT4 平台，开放智能交易模块，紧贴世界金融市场潮流。"},
        "metal15": {"en": "Follow masters' move", "zh": "复制跟单交易"},
        "metal16": {"en": "TigerWit provides the most advanced and most creative full-automatic order following system and gathers numerous investment masters with great profit-making capabilities. The investors can gain the earnings of the same proportion with the masters through following them. Masters can also gain more earnings through increasing their followers continuously.", "zh": "老虎外汇提供业内最先进，最具创新性的全自动复制跟单系统，并且汇聚众多颇具盈利能力的投资高手，投资者可通过复制高手交易获得同比例投资收益。高手也可通过不断增加跟随者而获得更多收益。"},
        "metal17": {"en": "Introduction to TigerWit precious metal products", "zh": "老虎外汇贵金属交易产品介绍"},
        ...
        "cfd5": {"en": "TigerWit's advantages in stock index and contracts for difference", "zh": "在老虎外汇做股指、差价合约的优势"},
        "cfd6": {"en": "Extensive products", "zh": "产品丰富"},
        "cfd7": {"en": "TigerWit offers the trading categories on global mainstream stock markets, including such mainstream stock index products as US Dollar Index, Nikkei and European blue chip index.", "zh": "老虎外汇提供全球主流股市交易品种，包含三大美指，日经，欧洲优选等等主流股指产品。"},
        ...
        "cfd13": {"en": "TigerWit provides the first-hand quotation from top banks, thus help investors achieve price discovering.", "zh": "老虎外汇提供来自于顶级银行的第一手数据报价，帮助投资者以进行价格发现。"},
        "cfd14": {"en": "Follow masters' move", "zh": "复制跟单交易"},
        "cfd15": {"en": "TigerWit provides the most advanced and most creative full-automatic order following system and gathers numerous investment masters with great profit-making capabilities. The investors can gain the earnings of the same proportion with the masters through following them. Masters can also gain more earnings through increasing their followers continuously.", "zh": "老虎外汇提供业内最先进，最具创新性的全自动复制跟单系统，并且汇聚众多颇具盈利能力的投资高手，投资者可通过复制高手交易获得同比例投资收益。高手也可通过不断增加跟随者而获得更多收益。"},
        "cfd16": {"en": "How to achieve stock index trade in TigerWit?", "zh": "在老虎外汇怎么做股指交易?"},
        "cfd17": {"en": "An investor of TigerWit bought one lot of European blue chip index (eustx50) around 10:00 on October 22, platform time of TigerWit at the position of 3260 by EUR 65.", "zh": "某位老虎外汇的投资者在老虎外汇的平台时间 10 月 22 号 10 点左右，于 3260 位置左右动用 65 欧元买入 1 手欧洲绩优指数（eustx50）。"},
        ...
        "cfd21": {"en": "Introduction to TigerWit financial stock index", "zh": "老虎外汇股指产品介绍"},
        ...
        "about8": {"en": "TigerWit investor-Tang Binsen", "zh": "老虎外汇投资人——唐彬森"},
        ...
        "risk12": {"en": "The trading platform offers precise order placing function and Tiger Wit will make every effort to trade based on the price demanded by the client. Though it is convenient, time-saving and efficient, online trading will not mitigate the risks involved in foreign exchange trades.", "zh": "交易平台提供精密的下单功能，老虎外汇将竭力依照客户所要求的价格执行交易。虽然在线交易方便省时兼有效率，但并不会降低外汇交易所涉及的风险。"},

        // （页面底部）条件和条款-客户声明 blog-statement
        "statement1": {"en": "I have read the Risk Disclosure Statement related to foreign exchange trade and Risk Warning and Exemptions for Trading on TIGERWIT Trading Platform, and have fully understood and accepted all contents contained in the above documents and learnt and acknowledged the contents and potential risks of order following trade. The investment decision of mine is made fully based on my independent judgment and I will bear all related risks and all consequences incurred thereby.", "zh": "本人已阅读跟随外汇交易的相关《风险披露书》、《老虎外汇交易平台风险提示免责条款》，并已完全理解和接受上述文件的全部内容，清楚了解跟单交易的内容及可能出现的风险。本人的投资决策完全基于本人的独立自主判断做出，并自愿承担因此产生的相关风险和全部后果。"},
        "statement2": {"en": "I agree and hereby appoint TigerWit as my consignor, which will exercise the trading right on behalf of me after I clicking \"Agree\", and agree to make trade in the mode of following the \"trading master\" opted by me and all obligations and risks produced thereby shall be undertaken by myself. ", "zh": "我同意并特此授权老虎外汇作为我的委托人，自我点击“同意”此项授权之时起，以我的名义代我行使交易之权利，并同意采用跟单方式跟随我自选的“交易高手”的信号进行交易，由此产生的一切责任和风险均由我个人承担。"},
        "statement3": {"en": "I have acknowledged the following rules of TigerWit that position will be opened based on the proportion between following capital and capital in account of the \"trading master\" and that position will be opened based on that of 0.01 for those less than 0.01 and the open order would be the following order.", "zh": "我已知晓老虎外汇的跟单规则：按照跟随资金与“交易高手”账户资金等比例开仓，不足0.01的按照0.01开仓，开仓订单即为跟随订单。"},
        "statement4": {"en": "I agree and authorize TigerWit to deduct 20% profits in real time from the concluded order at any natural month and check the overall amount of profits of the previous natural month prior to the 15th day of the following month. In addition, after calculating the commissions or bonuses, they will be paid to the \"trading master\" as commissions or bonuses for the following orders. I have confirmed and acknowledged that there are risks in order following trading and also learned that the historical performance of the \"trading master\" does not represent performance in the future and that all losses and responsibilities incurred by order following shall be borne by myself. ", "zh": "我同意并授权老虎外汇从我在任一自然月内已平仓的订单实时扣除20%利润，并于下一自然月15日前核对上一自然月整体盈利金额并核算佣金或奖金后，将其支付给“交易高手”作为跟单佣金或奖励。我确定已知晓跟单交易中存在的风险，知晓“交易高手”历史成绩不代表未来成绩，任何跟单操作导致的损失及责任由我个人承担。"},
        "statement5": {"en": "Risk Warning and Exemptions for Trading on TIGERWIT Trading Platform", "zh": "老虎外汇交易平台风险提示及免责条款"},
        "statement6": {"en": "1. TigerWit trading platform is a global social investment platform for individual investors and all services rendered by TigerWit are all in compliance with the law.", "zh": "1. 老虎外汇交易平台是从事为个人投资者提供全球化社交化投资平台， 老虎外汇向投资者提供的一切服务，均依托于法律法规之约束。"},
        "statement7": {"en": "2. TigerWit shall bear responsibilities for the order following services rendered, while all trading risks and consequences incurred by any operation (including but not limited to order following trade based on the trading behaviors of the \"trading master\") of any clients shall be borne by the client.", "zh": "2. 老虎外汇仅就跟单服务承担其责任，对于任何客户的任何操作（包括但不限于以“交易高手”之交易行为作为基础的跟单交易行为），其交易风险和交易结果均由客户自行承担。"},
        "statement8": {"en": "3. TigerWit shall not bear any profit and loss risks in trading or trading losses, unless there is any evidence proving that TigerWit should assume partial or all risks or responsibilities for a certain trade.", "zh": "3. 老虎外汇不承担任何客户的任何交易盈亏风险或交易损失，除非有任何相反证据表明老虎外汇对于某项交易应承担部分或全部风险或责任。"},
        "statement9": {"en": "4. Any information on TigerWit's website, including but not limited to comment, forecast, charts, indicators, theories, explicit or implied instructions, is for reference only. The investor shall bear liabilities on his/her own for any independent decisions. ", "zh": "4. 老虎外汇网站出现的信息包括但不限于评论、预测、图表、指标、理论、直接的或暗示的指示均只作为参考，您须对任何自主决定的行为负责。"},
        "statement10": {"en": "5. As for the \"trading masters\" and relevant information offered by TigerWit, TigerWit shall guarantee the accuracy of the historical data thereof, but shall not bear any liability for any losses caused by partial or all the above information or incurred by reliance on the above information.", "zh": "5. 老虎外汇所提供之“交易高手”及相关信息，老虎外汇保证其历史数据的准确性，老虎外汇不对因上述资料全部或部分内容产生的或因依赖该资料而引致的任何损失承担任何责任。"},
        "statement11": {"en": "6. TigerWit shall not assume any liability for compensation for any direct, indirect, derived or special losses due to use or failure to use order following services, unless there is any evidence proving that TigerWit shall be responsible for such losses. ", "zh": "6. 老虎外汇对于使用的跟单服务或无法使用跟单服务所导致的任何直接、间接、衍生或特别损害，不负任何赔偿责任，除非有任何相反证据表明老虎外汇应对此承担责任。"},
        "statement12": {"en": "7. In case of partial or full interruption, delay, misdirection or wrong data transmission or storage due to malfunction or failure of Internet software and hardware devices or human errors, or in case of garbled or forged data by third-party invasion system, TigerWit shall not bear any liabilities unless there is any contrary evidence. ", "zh": "7. 老虎外汇可能因合作方或网络提供商或电信部门的互联网软硬件设备故障或失灵、或人为操作疏忽而全部或部分中断、延迟、遗漏、误导或造成资料传输或储存上的错误、或遭第三人侵入系统篡改或伪造变造资料等，除非有相反证据否则老虎外汇不承担任何责任。"},
        "statement13": {"en": "8. With the consent and authorization of the client, TigerWit can initiate order following operation, perform order following transactions and deduct 20% of net profits earned by the client by order following to pay to the \"trading master\" as commissions or bonuses. The client has acknowledged and agreed to accept this order following mode and the profit deduction scheme and is also willing to bear the trading risks caused thereby. ", "zh": "8. 老虎外汇在获得客户同意并授权的情况下，可以为客户开启跟单操作及进行跟单交易、按约定实时扣除客户跟单净利润盈利中的20%支付给“交易高手”作为佣金或奖励。客户已知晓并同意接受该跟单交易模式，接受利润扣除方案，并愿意接受该交易模式的交易风险。"},

        // （页面底部）条件和条款-用户交易须知 blog-notice
        "notice1": {"en": "Trading Notes and Conditions", "zh": "交易须知和条件"},
        "notice2": {"en": "In accordance with the supervisory regulations, Tiger Wit reminds you to read these trading notes carefully. Unless you have learnt the nature of the contract concluded and the degree of potential risks to be confronted, it is not recommended to involve in trade of similar financial derivatives and clients are recommended to judge whether the product is suitable at his/her own discretion based on the conditions and financial status.", "zh": "依据监管规则，老虎外汇提醒您应详细阅读本交易须知。除非您了解所签订的合约性质以及所面临之风险程度，否则不应冒然进行类似的衍生性金融商品交易，同时您应根据本身的条件和财务状况，自行衡量该产品是否适合进行投资。"},
        ...
        "virtual2": {"en": "You can open an account by registering on website.?", "zh": "A：您可以通过网站注册获得老虎外汇的账户。"},
        ...
        "real8": {"en": "You can open the account on TigerWit immediately with complete information.", "zh": "A：只要您提供完备的信息，您可以在老虎外汇即时开户。"},
        ...
        "deal4": {"en": "Time", "zh": "时间"},
        "deal5": {"en": "Week", "zh": "星期"},
        "deal6": {"en": "TigerWit Display Time on the Transaction Platform", "zh": "老虎外汇交易平台显示时间"},
        ...
        "deal23": {"en": "TigerWit Display Time on the Transaction Platform", "zh": "老虎外汇交易平台显示时间"},
        ...
        "deal43": {"en": "If your Expert Advisors attacks server, TigerWit has the right to refuse your Expert Advisors.", "zh": "如果您的智能交易系统有攻击服务器的行为，老虎外汇有权利拒绝您的智能交易系统。"},
        ...
        "swap5": {"en": "TigerWit will update swap rate quotation daily as far as possible, but there might be violent fluctuations because of unpredictable market, which means that swap rate might be subject to big changes on the very day.", "zh": "老虎外汇尽可能每日及时更新隔夜利息报价，但不排除由于无法预测的市场情况而导致的剧烈波动，隔夜利息可能在当日内有变动。"},
        ...
        "video2": {"en": "TigerWit on CCTV", "zh": "老虎外汇首席策略分析师李彭为您解盘。"},
        ...
        "demo": {"en": "enenenenenenen", "zh": "zhzhzhzhzhzhzh"},
