...
module.exports = function () {
    var data = {
        ...
        "statement9": {"en": "4. Any information on TigerWit's website, including but not limited to comment, forecast, charts, indicators, theories, explicit or implied instructions, is for reference only. The investor shall bear liabilities on his/her own for any independent decisions. ", "zh": "4. 老虎外汇网站出现的任何信息包括但不限于评论、预测、图表、指标、理论、直接的或暗示的指示均只作为参考，您须对任何自主决定的行为负责。"},
        ...
        "statement14": {"en": "", "zh": "我已知晓在老虎外汇开户的所有客户均可以成为老虎外汇的“交易高手”，老虎外汇对于其客户成为“交易高手”没有设定具体的条件和标准。"},
