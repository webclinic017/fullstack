...
module.exports = function () {
    ...
    var data = {
        ...
        "openAccount": { "en": "Opening an account", "zh": "开立账户" },
        ...
        "foot_3": { "zh": "TigerWit-客户协议", "en": "TigerWit Client Agreement" },
        "foot_4": { "zh": "TigerWit-客户分类通知", "en": "TigerWit Client Categorization Notice" },
        "foot_5": { "zh": "TigerWit-投诉处理流程", "en": "TigerWit Complaint Handling Procedure" },
        "foot_6": { "zh": "TigerWit-利益冲突政策", "en": "TigerWit Conflicts of Interest Policy" },
        "foot_7": { "zh": "TigerWit-订单执行政策", "en": "TigerWit Order Execution Policy" },
        "foot_8": { "zh": "TigerWit-隐私政策和Cookie披露声明", "en": "TigerWit Privacy Policy and Cookie Disclosure" },
        "foot_9": { "zh": "TigerWit-保护客户资金", "en": "TigerWit Protecting Client Funds" },
        "foot_10": { "zh": "TigerWit-风险披露声明", "en": "TigerWit Risk Disclosure Notice" },
        "foot_11": { "zh": "TigerWit-商业条款及条件", "en": "TigerWit Terms and Conditions of Business" },
        "foot_12": { "zh": "TigerWit-负责任交易声明", "en": "TigerWit Trade Responsibly Notice" },
        "foot_13": { "zh": "TigerWit-交易条件声明", "en": "TigerWit Trading Conditions Notice" },
        "foot_14": { "zh": "您访问本网站，即表示您同意和理解本网站所附的条款和条件和网站上的所有资料。对于TigerWit Limited的客户，本公司保留在不通知您的情况下随时修改这些条款和条件的权利。所以您有责任定期检查这些条款和条件。如果您在修改之后继续使用本网站，即构成您接受修改。", "en": "By accessing this website, you signify your agreement with and understanding of the following Terms and Conditions pertaining to both this site and any material at it. For clients of TigerWit Limited, the Company reserves the right to change these Terms and Conditions at any time without notice to you. You are therefore responsible for regularly reviewing these Terms and Conditions. Continued use of this site following any such changes shall constitute your acceptance of such changes." },
        ...
        "foot_34": { "zh": "TigerWit Limited的客户访问本网站，即代表您同意不考虑法律冲突原则。巴哈马法律将适用于所有与使用本网站有关的事宜。如有任何争议，您同意巴哈马具有排他性司法管辖权。在任何条款和条件无法执行的情况下，其余条款和条件不受损害，无法执行的条款和条件应由此类最接近无法执行条款或条件潜在意图的可执行条款和条件所替换。本协议并不替代或以任何方式修改您与本公司签署的任何其他协议。", "en": "For clients of TigerWit Limited, by accessing this site, you agree that the laws of The Bahamas, without regard to Conflict of Laws principles thereof, will apply to all matters relating to the use of this site. In case of a dispute, you agree to the exclusive jurisdiction of The Bahamas. In the event any of the Terms and Conditions shall be held to be unenforceable, the remaining Terms and Conditions shall be unimpaired and the unenforceable Term or Condition shall be replaced by such enforceable Term or Condition as comes closest to the intention underlying the unenforceable Term or Condition. This Agreement does not replace or in any way amend any other agreement you have entered into with the Company." },
        ...
        "foot_38": {"zh": "风险警告：", "en": "Risk Warning:"},
        "foot_39_1": {"zh": "差价合约交易涉及风险，可能导致你的资本损失。TigerWit有限公司(巴哈马)由巴哈马证券委员会(SCB)监管，牌照号码SIA-F185。要访问TigerWit 有限公司(英国)的网站，请点击这里：", "en": "Trading CFDs involves risk and can result in loss of your capital. TigerWit Limited (Bahamas) is regulated by Securities Commission of The Bahamas (SCB), license number SIA-F185. To access the website for TigerWit Limited (UK), which is authorised and regulated in the UK by the Financial Conduct Authority (FCA), please click here: "},
        "foot_39_2": {"zh": "，TigerWit有限公司（英国）由英国金融市场行为监管局(FCA)授权和监管。", "en": " "},
        ...
        //"home25": {"en": "Achieve gold and silver trading by one account", "zh": "一个账户交易黄金、白银"},
        ...
        "home67": { "en": "Prices are indicative. No quotations are updated over Saturdays and Sundays.", "zh": "订单报价实时更新，周六日停盘无报价。" },
        ...
        "forex23": { "en": "Average spread", "zh": "点差" },
        "forex24": { "en": "points", "zh": "平均点差" },
        ...
        "metal11": { "en": "Achieve gold and silver trading by one account", "zh": "一个账户交易黄金、白银" },
        ...
        copyRule14: {zh: "1.复制成功后，高手平仓，账户会跟随高手同步平仓，该笔订单盈亏将会记入复制金额内。", en: "1. After successful copy, the account will follow the master to close orders synchronously, the profit and loss of these orders will be credited to the reproduction amount."},
        copyRule15: {zh: "2.您可以手动平仓复制高手的订单，不会取消复制关系。", en: "2.You can manually close orders that following the master, and the copy relationship will still exist."},
        copyRule16: {zh: "3.您可以修改订单状态，跟随高手开仓的订单可在APP中修改为：不跟随高手平仓。状态修改成功后，高手平仓，该笔订单将不会跟随平仓，由您手动平仓或设置止盈/止损平仓。", en: "3.You can change the order’s state into: Do not follow to close. This order will not follow to close when master close position once the state is changed, and you can set take profit and stop loss manually."},
        copyRule17: {zh: "4.您取消复制关系时，可自主选择强行平仓或者跟随高手平仓正在持仓中订单。", en: "4.You can choose cancel and follow the close or cancel and force a flat when you unfollowing a master."},
        copyRule18: {zh: "5.用户复制高手所产生的盈利或亏损，网站不承担任何责任。", en: "5. The website assumes no liability to the profit and loss caused by copying masters."},
        copyRule19: {zh: "复制高手盈利分成", en: "Copy master profit share"},
        copyRule20: {zh: "1.每月1日，系统对您跟随高手的情况进行统计并结算，扣除跟随该高手盈利部分的20%作为该高手的分成；每月10日，系统对高手进行分成结算。", en: "1. System will statistics and settlement the master’s situation, and deduct 20% copy profit as commission; System will make commission settlement on the 10th of each month."},
        copyRule21: {zh: "2.您取消复制关系选择强制平仓时，系统将对跟随该高手的所有订单进行统计并结算，扣除盈利部分的20%作为该高手分成。", en: "2. System will statistics and settlement all the orders and deduct 20% as commission when you cancel and force a flat."},
        ...
        "sidebar4": { "en": "Open a virtual account", "zh": "开立模拟账户" },
        "sidebar5": { "en": "Open an account", "zh": "开立账户" },
        "sidebar6": { "en": "Deposit and withdrawal", "zh": "出入金" },
        "sidebar7": { "en": "Types of accounts", "zh": "账户类型" },
        ...
        "virtual8": { "en": "There is an amount of $10,000 funded on your virtual account, please contact us if you need more virtual funds.", "zh": "A：模拟账户默认有 1 万美金的资金量，如果您还需要更多的模拟资金，请您联系我们。" },
        ...
        "deal4": { "en": "Time", "zh": "时间" },
        "deal5": { "en": "Week", "zh": "星期" },
        "deal6": { "en": "Transaction Platform Time (GMT+3)", "zh": "交易平台显示时间 (GMT+3)" },
        "deal7": { "en": "Beijing Time (GMT+8)", "zh": "北京时区 (GMT+8)" },
        "deal8": { "en": "Summer Time", "zh": "夏令时" },
        "deal9": { "en": "From Monday to Friday", "zh": "周一到周五" },
        "deal10": { "en": "From 0:05am on Monday to 23:55pm on Friday", "zh": "周一00:05-周五23:55" },
        "deal11": { "en": "From 5:05am on Monday to 04:55am on Saturday", "zh": "周一05:05-周六04:55" },
        "deal12": { "en": "Description", "zh": "说明" },
        "deal13": { "en": "The period from 23:55pm to 00:05am (GMT+3) is for platform maintenance, no price quotation shall be provided.", "zh": "交易平台时间周二到周五23:55-00:05为维护时间，不提供报价" },
        "deal14": { "en": "Winter Time", "zh": "冬令时" },
        "deal15": { "en": "From Monday to Friday", "zh": "周一到周五" },
        "deal16": { "en": "From 01:05am on Monday to 00:55am on Saturday", "zh": "周一01:05-周六00:55" },
        "deal17": { "en": "From 06:05am on Monday to 05:55am on Saturday", "zh": "周一06:05-周六05:55" },
        "deal18": { "en": "Description", "zh": "说明" },
        "deal19": { "en": "The period from 00:5apm to 01:05am (GMT+3) is for platform maintenance, no price quotation shall be provided.", "zh": "交易平台时间周二到周五00:55-01:05为维护时间，不提供报价" },
        "deal20": { "en": "Precious metal", "zh": "贵金属" },
        "deal21": { "en": "Time", "zh": "时间" },
        "deal22": { "en": "Week", "zh": "星期" },
        "deal23": { "en": "Transaction Platform Time (GMT+3)", "zh": "交易平台显示时间 (GMT+3)" },
        "deal24": { "en": "Beijing Time (GMT+8)", "zh": "北京时区 (GMT+8)" },
        "deal25": { "en": "Summer Time", "zh": "夏令时" },
        "deal26": { "en": "From Monday to Friday", "zh": "周一到周五" },
        "deal27": { "en": "From 01:00am on Monday to 00:00am on Saturday", "zh": "周一01:00-周六00:00" },
        "deal28": { "en": "From 06:00am on Monday to 05:00am on Saturday", "zh": "周一06:00-周六05:00" },
        "deal29": { "en": "Description", "zh": "说明" },
        "deal30": { "en": "The period from 00:00am to 01:00am (GMT+3) is for platform maintenance, no price quotation shall be provided.", "zh": "交易平台时间周二到周五00:00-01:00休市，不提供报价" },
        "deal31": { "en": "Winter Time", "zh": "冬令时" },
        "deal32": { "en": "From Monday to Friday", "zh": "周一到周五" },
        "deal33": { "en": "From 02:00am on Monday to 01:00am on Saturday", "zh": "周一02:00-周六01:00" },
        "deal34": { "en": "From 07:00am on Monday to 06:00am on Saturday", "zh": "周一07:00-周六06：00" },
        "deal35": { "en": "Description", "zh": "说明" },
        "deal36": { "en": "The period from 01:00am to 02:00am (GMT+3) is for platform maintenance, no price quotation shall be provided.", "zh": "交易平台时间周二到周五01:00-02:00休市，不提供报价" },
        "deal37": { "en": "Why forced liquidation happens to the deal I made?", "zh": "Q：我下的单被强行平仓，为什么？" },
        "deal38": { "en": "When the margin ration (margin/free margin) is below 100% on common accounts and the margin ration is below 200% on masters’ accounts, the company will effect forced liquidation starting from your deal with the highest loss.", "zh": "A：您的订单被强制平仓了，当普通账户保证金比率（保证金/使用的保证金）低于100%，高手账户的保证金比率（保证金/使用的保证金）低于200%，系统会从您损失最大的订单开始平仓的。" },
        ...
        "platform9": { "en": "Your virtual account won't be deleted if you login and put some trades within 30 days, otherwise the virtual account will be deleted by the system.", "zh": "A：模拟账户默认有 1 万美金的资金量，如果您还需要更多的模拟资金，请您联系我们。" },
        ...
        */
        ...
        amtIndex7: { zh: "客户协议将约束TigerWit与您之间的关系。", en: "The Client Agreement will constrain the relationship between TigerWit and you." },
        amtIndex8: { zh: "风险披露声明", en: "Risk Disclosure Notice" },
        amtIndex9: { zh: "在您使用TigerWit服务之前，您必须根据您的情况和财务情况，慎重考虑您是否适合进行CFD交易。", en: "Before you use the TigerWit’s service, you must consider carefully whether you are suitable for CFD trading based on your circumstances and financial situation." },
        amtIndex10: { zh: "隐私政策和Cookie披露声明", en: "Privacy Policy and Cookie Disclosure" },
        amtIndex11: { zh: "本文档详述有关TigerWit管理个人资料的政策。", en: "This document describes the management of TigerWit Personal Data Policy in detail." },
        amtIndex12: { zh: "商业条件及条款", en: "Terms and Conditions of Business" },
        amtIndex13: { zh: "本文档详述TigerWit的金融服务指南，旨在帮助您决定是否使用我们提供的服务。", en: "This document describes TigerWit Limited Services Guide in detail, designed to help you decide whether to use the services we provide or not." },
        ...
        amtIndex19: { zh: "阅读并了解TigerWit交易平台风险提示及免责条款。", en: "Read and understand the TigerWit Trading Risk Reminder and Exemption Clauses." },
        ...
        amtIndex23: { zh: "本文档详述有关TigerWit保护您的资金所采取的措施。", en: "This document describes the measures taken by TigerWit to protect your funds in detail." },
        ...
        amtLegal22: { zh: "TigerWit Limited的客户访问本网站，即代表您同意不考虑法律冲突原则。巴哈马法律将适用于所有与使用本网站有关的事宜。如有任何争议，您同意巴哈马具有排他性司法管辖权。在任何条款和条件无法执行的情况下，其余条款和条件不受损害，无法执行的条款和条件应由此类最接近无法执行条款或条件潜在意图的可执行条款和条件所替换。本协议并不替代或以任何方式修改您与本公司签署的任何其他协议。", en: "For clients of TigerWit Limited, by accessing this site, you agree that the laws of The Bahamas, without regard to Conflict of Laws principles thereof, will apply to all matters relating to the use of this site. In case of a dispute, you agree to the exclusive jurisdiction of The Bahamas. In the event any of the Terms and Conditions shall be held to be unenforceable, the remaining Terms and Conditions shall be unimpaired and the unenforceable Term or Condition shall be replaced by such enforceable Term or Condition as comes closest to the intention underlying the unenforceable Term or Condition. This Agreement does not replace or in any way amend any other agreement you have entered into with the Company." },
        // client - 客户协议
        amtClient1: { zh: "序言", en: "Introduction" },
        amtClient2: { zh: "1.TigerWit Limited（以下统称为“TigerWit”、“公司”或”本公司”）在巴哈马国注册成立（注册证书编号 198255B）。我们 的 注 册 办 事 处 位 于 201 Church Street, Sandyport, P. O. Box SP 64368.Nassau, TheBahamas。TigerWit 受巴哈马证券监察委员会授权和监管（注册编号 SIA-F185）。", en: "1.TigerWit Limited (hereinafter referred to as ‘TigerWit’, the ‘Firm’ or the 'Company') is incorporated (Certificate of Incorporation No. 198255B) in The Commonwealth of The Bahamas. Our registered office is 201 Church Street, Sandyport, P. O. Box SP 64368. Nassau, The Bahamas. TigerWit is authorised and regulated by the Securities Commission of The Bahamas (licence No. SIA-F185)." },
        ...
        amtClient82: { zh: "15.在以下情况下，本公司有权关闭客户资金余额无人提取的账户以及从独立客户银行账户中释放任何客户资金余额的账户：", en: "15.The Firm reserves the right to close an account in connection with an unclaimed client money balance and releasing any client money balances from segregated client bank accounts if:" },
        ...
        amtClient131: { zh: "1.TigerWit Limited 在 巴哈马国注册总局注册；因此，任何客户的个人数据均由 TigerWit 依据巴哈马国的法律法规进行保存。", en: "1.TigerWit Limited is registered with the Registrar General's Department of The Bahamas; therefore, any clients’ personal data is kept by TigerWit according to the laws and regulations of The Bahamas." },
        ...
        amtRisk3: { zh: "1.TigerWit Limited（以下简称“TigerWit”、“本公司”、“我们”）为您提供“风险披露声明”（“声明”），以帮助您了解交易差价合约（“CFD”）时可能会出现的风险。但是您需要牢记，该声明并没有包含交易 CFD 所涉及的所有风险和问题。客户（以下称为“客户”、“您”、和“您自己”）应仔细阅读“声明”和“客户协议”、“订单执行政策”以及您可通过我们的网站获取的文件和信息。", en: "1.TigerWit Limited (referred to as ‘TigerWit’, the ‘Firm’, ‘us’, ‘we’ and ‘our’) provides you with this ‘Risk Disclosure Notice’ (the ‘Notice’) to help you understand the risks that might arise when trading Contracts for Difference (‘CFDs’). However, you need to bear in mind that the Notice does not contain all the risks and aspects involved in trading CFDs. The Client (referred to as the ‘Client’, ‘you’, ‘your’ and ‘yourself’) should carefully read the Notice in conjunction with the ‘Client Agreement’, the ‘Order Execution Policy’ and the documentation and information available to you through our Website." },
        ...
        amtCookie7: { zh: "TigerWit Limited 在巴哈马国注册总局注册；因此，任何客户的个人数据均由TigerWit 依据巴哈马国的法律法规进行保存。", en: "TigerWit Limited is registered with the Registrar General's Department of The Bahamas; therefore, any clients’ personal data is kept by TigerWit according to the laws and regulations of The Bahamas." },
        ...
        amtBusiness2: { zh: "1.TigerWit Limited（以下统称为“TigerWit”、“公司”或“本公司”）在 巴 哈 马 国 注 册 成 立 （ 注 册 证 书 编 号198255B）。我们的注册办事处位于 201 ChurchStreet, Sandyport, P. O. Box SP 64368.Nassau, TheBahamas。TigerWit 受巴哈马证券监察委员会授权和监管（注册编号 SIA-F185）。", en: "1.TigerWit Limited (hereinafter referred to as ‘TigerWit’, the ‘Firm’ or the 'Company') is incorporated (Certificate of Incorporation No. 198255B) in The Commonwealth of The Bahamas. Our registered office is 201 Church Street, Sandyport, P. O. Box SP 64368. Nassau, The Bahamas. TigerWit is authorised and regulated by the Securities Commission of The Bahamas (licence No. SIA-F185)." },
        ...
        amtBusiness99: { zh: "客户的名字和姓氏；客户的交易账号；受影响的交易订单号（如果适用）；问题出现的日期和时间；和问题描述。", en: "the client’s name and surname; the client’s trading account number; the affected transaction numbers, if applicable; the date and time that the issue arose; and a description of the issue." },
        ...
        amtStatement2: { zh: "本人已阅读跟随外汇交易的相关《风险披露书》、《TigerWit交易平台风险提示免责条款》，并已完全理解和接受上述文件的全部内容，清楚了解跟单交易的内容及可能出现的风险。本人的投资决策完全基于本人的独立自主判断做出，并自愿承担因此产生的相关风险和全部后果。", en: "I have read the Risk Disclosure Statement related to foreign exchange trade and Risk Warning and Exemptions for Trading on TigerWit Trading Platform, and have fully understood and accepted all contents contained in the above documents and learnt and acknowledged the contents and potential risks of order following trade. The investment decision of mine is made fully based on my independent judgment and I will bear all related risks and all consequences incurred thereby." },
        amtStatement3: { zh: "我同意并特此授权TigerWit作为我的委托人，自我点击“同意”此项授权之时起，以我的名义代我行使交易之权利，并同意采用跟单方式跟随我自选的“交易高手”的信号进行交易，由此产生的一切责任和风险均由我个人承担。", en: "I agree and hereby appoint TigerWit as my consignor, which will exercise the trading right on behalf of me after I clicked \"Agree\", and agree to make trade in the mode of following the \"trading master\" opted by me and all obligations and risks produced thereby shall be undertaken by myself." },
        amtStatement4: { zh: "我已知晓TigerWit的跟单规则：按照跟随资金与“交易高手”账户资金等比例开仓，不足0.01的按照0.01开仓，开仓订单即为跟随订单。我已知晓在TigerWit开户的所有客户均可以成为TigerWit的“交易高手”，TigerWit对于其客户成为“交易高手”没有设定具体的条件和标准。", en: "I have acknowledged the following rules of TigerWit that position will be opened based on the proportion between following capital and capital in account of the \"trading master\" and that position will be opened based on that of 0.01 for those less than 0.01 and the open order would be the following order.I have known that all customers in the TigerWit's foreign exchange accounts can become a foreign exchange trading master, tiger foreign exchange for its customers to become a trading master did not set specific conditions and standards." },
        amtStatement5: { zh: "我同意并授权TigerWit从我在任一自然月内已平仓的订单实时扣除20%利润，并于下一自然月15日前核对上一自然月整体盈利金额并核算佣金或奖金后，将其支付给“交易高手”作为跟单佣金或奖励。我确定已知晓跟单交易中存在的风险，知晓“交易高手”历史成绩或历史业绩不代表未来成绩或业绩，任何跟单操作导致的损失及责任由我个人承担。", en: "I agree and authorize TigerWit to deduct 20% profits in real time from the concluded order at any natural month and check the overall amount of profits of the previous natural month prior to the 15th day of the following month. The 20% profit is the only fee for “trading master”. In addition, after calculating the commissions or bonuses, they will be paid to the \"trading master\" as commissions or bonuses for the following orders. I have confirmed and acknowledged that there are risks in order following trading and also learned that the historical performance of the \"trading master\" does not represent performance in the future and that all losses and responsibilities incurred by order following shall be borne by myself." },
        amtStatement6: { zh: "TigerWit交易平台风险提示及免责条款", en: "Risk Warning and Exemptions for Trading on TigerWit Trading Platform" },
        amtStatement7: { zh: "1. TigerWit交易平台是从事为个人投资者提供全球化社交化投资平台， TigerWit向投资者提供的一切服务，均依托于法律法规之约束。", en: "1. TigerWit trading platform is a global social investment platform for individual investors and all services rendered by TigerWit are all in compliance with the law." },
        amtStatement8: { zh: "2. TigerWit仅就跟单服务承担其责任，对于任何客户的任何操作（包括但不限于以“交易高手”之交易行为作为基础的跟单交易行为），其交易风险和交易结果均由客户自行承担。", en: "2. TigerWit shall bear responsibilities for the order following services rendered, while all trading risks and consequences incurred by any operation (including but not limited to order following trade based on the trading behaviors of the \"trading master\") of any clients shall be borne by the client." },
        amtStatement9: { zh: "3. TigerWit不承担任何客户的任何交易盈亏风险或交易损失，除非有任何相反证据表明TigerWit对于某项交易应承担部分或全部风险或责任。", en: "3. TigerWit shall not bear any profit and loss risks in trading or trading losses, unless there is any evidence proving that TigerWit should assume partial or all risks or responsibilities for a certain trade." },
        amtStatement10: { zh: "4. TigerWit网站出现的任何信息包括但不限于评论、预测、图表、指标、理论、直接的或暗示的指示均只作为参考，您须对任何自主决定的行为负责。", en: "4. Any information on TigerWit's website, including but not limited to comment, forecast, charts, indicators, theories, explicit or implied instructions, is for reference only. The investor shall bear liabilities on his/her own for any independent decisions." },
        amtStatement11: { zh: "5. TigerWit所提供之“交易高手”及相关信息，TigerWit保证其历史数据的准确性，TigerWit不对因上述资料全部或部分内容产生的或因依赖该资料而引致的任何损失承担任何责任。", en: "5. As for the \"trading masters\" and relevant information offered by TigerWit, TigerWit shall guarantee the accuracy of the historical data thereof, but shall not bear any liability for any losses caused by partial or all the above information or incurred by reliance on the above information." },
        amtStatement12: { zh: "6. TigerWit对于使用的跟单服务或无法使用跟单服务所导致的任何直接、间接、衍生或特别损害，不负任何赔偿责任，除非有任何相反证据表明TigerWit应对此承担责任。", en: "6. TigerWit shall not assume any liability for compensation for any direct, indirect, derived or special losses due to use or failure to use order following services, unless there is any evidence proving that TigerWit shall be responsible for such losses." },
        amtStatement13: { zh: "7. TigerWit可能因合作方或网络提供商或电信部门的互联网软硬件设备故障或失灵、或人为操作疏忽而全部或部分中断、延迟、遗漏、误导或造成资料传输或储存上的错误、或遭第三人侵入系统篡改或伪造变造资料等，除非有相反证据否则TigerWit不承担任何责任。", en: "7. In case of partial or full interruption, delay, misdirection or wrong data transmission or storage due to malfunction or failure of Internet software and hardware devices or human errors, or in case of garbled or forged data by third-party invasion system, TigerWit shall not bear any liabilities unless there is any contrary evidence." },
        amtStatement14: { zh: "8. TigerWit在获得客户同意并授权的情况下，可以为客户开启跟单操作及进行跟单交易、按约定实时扣除客户跟单净利润盈利中的20%支付给“交易高手”作为佣金或奖励。客户已知晓并同意接受该跟单交易模式，接受利润扣除方案，并愿意接受该交易模式的交易风险。", en: "8. With the consent and authorization of the client, TigerWit can initiate order following operation, perform order following transactions and deduct 20% of net profits earned by the client by order following to pay to the \"trading master\" as commissions or bonuses. The client has acknowledged and agreed to accept this order following mode and the profit deduction scheme and is also willing to bear the trading risks caused thereby." },
        // categorization - 客户分类通知
        amtCategorization1: { zh: "序言", en: "Introduction" },
        amtCategorization2: { zh: "1.TigerWit Limited（以下统称为“TigerWit”、“公司”或“本公司”）在 巴 哈 马 国 注 册 成 立 （ 注 册 证 书 编 号198255B）。我们的注册办事处位于 201 ChurchStreet, Sandyport, P. O. Box SP 64368.Nassau, TheBahamas。TigerWit 受巴哈马证券监察委员会授权和监管（注册编号 SIA-F185）。", en: "1.TigerWit Limited (hereinafter referred to as ‘TigerWit’, the ‘Firm’ or the 'Company') is incorporated (Certificate of Incorporation No. 198255B) in The Commonwealth of The Bahamas. Our registered office is 201 Church Street, Sandyport, P. O. Box SP 64368. Nassau, The Bahamas. TigerWit is authorised and regulated by the Securities Commission of The Bahamas (licence No. SIA-F185)." },
        ...
        // funds - 保护客户资金
        amtFunds1: { zh: "作为一家受监管的实体，TigerWit Limited 符合下列有关客户资金的监管要求：", en: "As a regulated entity, TigerWit Limited meets the following regulatory requirements relating to client funds:" },
        ...
        amtExecution2: { zh: "1.TigerWit Limited（以下统称为“TigerWit”、“公司”或“本公司”）在 巴 哈 马 国 注 册 成 立 （ 注 册 证 书 编 号198255B）。我们的注册办事处位于 201 ChurchStreet, Sandyport, P. O. Box SP 64368.Nassau, TheBahamas。TigerWit 受巴哈马证券监察委员会授权和监管（注册编号 SIA-F185）。", en: "1.TigerWit Limited (hereinafter referred to as ‘TigerWit’, the ‘Firm’ or the 'Company') is incorporated (Certificate of Incorporation No. 198255B) in The Commonwealth of The Bahamas. Our registered office is 201 Church Street, Sandyport, P. O. Box SP 64368. Nassau, The Bahamas. TigerWit is authorised and regulated by the Securities Commission of The Bahamas (licence No. SIA-F185)." },
        ...
        amtExecution20: { zh: "订单类型", en: "Order Type" },
        amtExecution21: { zh: "执行即时订单", en: "Execution Instant Order(s)" },
        ...
        amtConflicts2: { zh: "1.TigerWit Limited（以下统称为“TigerWit”、“公司”或“本公司”）在 巴 哈 马 国 注 册 成 立 （ 注 册 证 书 编 号198255B）。我们的注册办事处位于 201 ChurchStreet, Sandyport, P. O. Box SP 64368.Nassau, TheBahamas。TigerWit 受巴哈马证券监察委员会授权和监管（注册编号 SIA-F185）。", en: "1.TigerWit Limited (hereinafter referred to as ‘TigerWit’, the ‘Firm’ or the 'Company') is incorporated (Certificate of Incorporation No. 198255B) in The Commonwealth of The Bahamas. Our registered office is 201 Church Street, Sandyport, P. O. Box SP 64368. Nassau, The Bahamas. TigerWit is authorised and regulated by the Securities Commission of The Bahamas (licence No. SIA-F185)." },
        ...
        amtComplaint16: { zh: "1.TigerWit Limited（以下统称为“TigerWit”、“公司”或“本公司”）在 巴 哈 马 国 注 册 成 立 （ 注 册 证 书 编 号198255B）。我们的注册办事处位于 201 ChurchStreet, Sandyport, P. O. Box SP 64368.Nassau, TheBahamas。TigerWit 受巴哈马证券监察委员会授权和监管（注册编号 SIA-F185）。", en: "1.TigerWit Limited (hereinafter referred to as ‘TigerWit’, the ‘Firm’ or the 'Company') is incorporated (Certificate of Incorporation No. 198255B) in The Commonwealth of The Bahamas. Our registered office is 201 Church Street, Sandyport, P. O. Box SP 64368. Nassau, The Bahamas. TigerWit is authorised and regulated by the Securities Commission of The Bahamas (licence No. SIA-F185)." },
        ...
        downloadApp: {
            title: {zh: "下载APP", en: "Download APP"},
            tip1: {zh: "复制跟单", en: "Follow a master to trade"},
            tip2: {zh: "无需精通外汇知识，跟着高手坐享其成", en: "No need to master forex knowledge, just follow a master and enjoy the profit."},
            ...
            lowThreshold: {zh: "门槛低", en: "Low threshold"},
            tip9_1: {zh: "开户就送$200体验金，", en: "TigerWit will send you $200 experience"},
            tip9_2: {zh: "最低$10元就能交易", en: " funds when you open an account, and a minimum"},
            tip9_3: {zh: " ", en: "of $10 can be traded"},
            highIncome: {zh: "高收益", en: "High income"},
            tip10_1: {zh: "涨跌皆有机会盈利，多倍杠杆，", en: "You will always have chance to take profit"},
            tip10_2: {zh: "$200当做$2000使用", en: "no matter rise or fall, multiple levers, "},
            tip10_3: {zh: " ", en: "$200 could be used as $2000"},
            easyOperation: {zh: "易操作", en: "Easy operation"},
            tip11_1: {zh: "移动端交易，简便易懂，", en: "Mobile end trade, easy to understand, "},
            tip11_2: {zh: "会炒股就会简单操作", en: "the operation could be very easy if you ever trade stocks"},
            moreOpportunities: {zh: "机会多", en: "More opportunities"},
            tip12_1: {zh: "24小时交易、T+0交易，", en: "Trade 24 hours, T+0 trading, "},
            tip12_2: {zh: "大小行情不错过", en: "never miss one market"},
            followMasters: {zh: "高手跟单", en: "Follow masters"},
            tip13_1: {zh: "无需精通理财知识，复制交易高手，", en: "No need to master forex knowledge, just follow a master, "},
            tip13_2: {zh: "把握操盘机会", en: "grasp the opportunity of operating"},
            fairMarket: {zh: "市场公平", en: "Fair market"},
            tip14: {zh: "国际市场，每天5万亿以上成交量", en: "International market, over 5 trillion transactions a day."},
            tip15: {zh: "APP 链接全球金融市场", en: "APP Link to global financial markets"},
            tip16: {zh: "人人都是投资高手—你准备好了吗？", en: "Trade like a master—Are you ready for it?"},
            androidVersion: {zh: "Android版", en: "Android Version"},
            iPhoneVersion: {zh: "iPhone版", en: "iPhone Version"},
            tip17: {zh: "扫码轻松赚收益", en: "Scan QR code and take profit easily"},
            tip18:{zh: "专业外汇交易团队带你钱生钱", en: "Professional trading team with your money to make money"},
            tip19:{zh: "随时随地一键交易,把握财富主动权", en: "Trading anytime anywhere, hold the wealth initiative"},
            mobileEndTradingSystem:{zh: "移动端交易系统", en: "Mobile-end trading system"},
            regularFollow: {zh: "定期跟单", en: "Regular Follow"},
            howChooseMaster: {zh: "如何选择高手", en: "How to choose a master"},
            analysis: {zh: "每日汇评", en: "Analysis"},
            calendar: {zh: "财经日历", en: "Calendar"},
            guides: {zh: "交易指南", en: "Guides"},
            partners: {zh: "合作伙伴", en: "Partners"},
            agencies: {zh: "代理合作", en: "Agencies"},
        ...
        partner: {
            becomePartner: {zh: "诚招合作伙伴", en: "Become a TigerWit partner today"},
            becomePartner_1: {zh: "运用新的技术建立和推广一个成功的本地或全球品牌是我们的愿景，这需要TigerWit与您共同实现。成为我们的代理商，您可以获得TigerWit所有工具支持，同时享受多项优秀代理商扶持计划，轻松实现合作共赢、财富共享。与我们合作，利用您富余的资源创造意想不到的价值！", en: "With TigerWit, the success of our partners comes from developing long-term profitable relationships. We aim to bring a fresh technological approach to an industry in need of change that benefits both partners and traders. Our innovative ‘Distributed Ledger Technology’ can provide you with an unique and significant advantage over your competitors. TigerWit’s distributed trading ledger is just the first step. Visit tech.tigerwit.com for more information on our blockchain technology."},
            joinUs: {zh: "加入我们", en: "Join us"},
            whyPartner: {zh: "为什么选择我们？", en: "Why partner with TigerWit?"},
            whyPartner_1: {zh: "让TigerWit的专家为您提供量身定制的解决方案", en: "Looking to grow your business? Let TigerWit’s experts deliver a solution tailored to you."},
            supportPlan: {zh: "优秀代理商扶持计划", en: "Excellent agency support plan"},
            supportPlan_1: {zh: "薪资支持、客户服务支持、激励支持、返佣支持、培训支持、公关支持等丰富的扶持成长体系，帮您快速成为专业代理人，实现人生小目标！", en: "Rich support and growth systems, such as salary support, customer service support, incentive support, commission return support, training support, and public relations support, help you quickly become a professional agent to achieve your life goals!"},
            customerPromotionSystem: {zh: "客户推广系统", en: "Customer promotion system"},
            customerPromotionSystem_1: {zh: "节庆日宣传图、二维码及推广链接、汇评咨询推文等一键获取，满足您多种推广需求，简单快捷！", en: "Get designed promotion photo, QR code, promotion link, strategy comments, and tweets to meet your needs, simple and fast!"},
            safeReliable: {zh: "安全可靠", en: "Safe and reliable"},
            safeReliable_1: {zh: "团队汇集了具有不同学术和应用背景的专业人士，分别在外汇交易、差价合约、监管合规性、投资管理、在线平台研发和全球营销等方面拥有丰富的经验，为您的资金保驾护航！", en: "With a strong technological core built upon a philosophy of transparency, credibility and integrity, TigerWit offers its clients exceptional capabilities to trade in the markets. TigerWit’s founders are experienced individuals with successful backgrounds and a long history of achievement, who bring together a team of professionals with diverse academic and applied backgrounds experienced in trading Forex, CFD and spread betting, regulatory compliance, investment management, research & development of online platforms and global sales & marketing."},
            whatOffer: {zh: "我们提供什么？", en: "What do we offer?"},
            whatOffer_1: {zh: "获得所有的工具和支持，以建立和推广一个成功的本地或全球品牌", en: "Access to all the tools and support your business needs to build and market a successful local or global brand."},
            offer_1: {zh: "区块链技术", en: "Innovative distributed trading ledger"},
            offer_2: {zh: "复制跟单模式", en: "Copy-trading technology"},
            offer_3: {zh: "24/5客户及技术支持", en: "24/5 client and technology support"},
            offer_4: {zh: "智能便捷的交易APP", en: "An easy-to-use, highly intuitive mobile trading app"},
            offer_5: {zh: "快速简易传播", en: "Competitive spreads"},
            offer_6: {zh: "深度市场流动性", en: "Deep market liquidity"},
            offer_7: {zh: "独家合作伙伴英超利物浦", en: "Exclusive promotions with our partner, Liverpool FC"},
            offer_8: {zh: "直观数据报告", en: "Advanced reporting"},
            offer_9: {zh: "FCA、SCB监管", en: "Regulation by FCA and SCB"},
            becomePartnerFlow: {zh: "成为合作伙伴流程", en: "Become a partner"},
            signUpAccount: {zh: "注册账户", en: "Sign up for an account"},
            overProbationPeriod: {zh: "完成磨合期条件", en: "Over the probation period"},
            endTrial: {zh: "磨合结束，成为代理", en: "End of trial, become an official agent"},
            becomePartnerFlow_1: {zh: "请填写以下表格，我们将联系您提供更多的信息和回答任何问题。", en: "Please complete the form below and we will be in touch to provide more information and answer any questions."},
            becomePartnerFlow_2: {zh: "我们期待着您的信息。", en: "We look forward to hearing from you."},
            name: {zh: "姓名", en: "Name"},
            country: {zh: "国家", en: "Country"},
            email: {zh: "邮箱", en: "Email"},
            phone: {zh: "手机号", en: "Phone"},
            message: {zh: "备注信息（选填）", en: "Message(optional)"},
            complusoryInformation: {zh: "以下信息中邮箱和手机号必选一项填写", en: "You should fill in one of email address or phone number as complusory information"},
            sendAgent: {zh: "申请代理", en: "Send"}
        },
        header: {
