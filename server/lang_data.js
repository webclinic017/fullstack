...
module.exports = function () {
    var data = {
        ...
        "virtual2": {"en": "You can open an account by registering on website.?", "zh": "A：您可以通过网站注册获得 TigerWit 的账户。"},
        ...
        "real8": {"en": "You can open the account on TigerWit immediately with complete information.", "zh": "A：只要您提供完备的信息，您可以在 TigerWit 即时开户。"},
        ...
        "deal4": {"en": "Time", "zh": "时间"},
        "deal5": {"en": "Week", "zh": "星期"},
        "deal6": {"en": "TigerWit Display Time on the Transaction Platform", "zh": "TigerWit 交易平台显示时间"},
        ...
        "deal23": {"en": "TigerWit Display Time on the Transaction Platform", "zh": "TigerWit 交易平台显示时间"},
        ...
        "deal43": {"en": "If your Expert Advisors attacks server, TigerWit has the right to refuse your Expert Advisors.", "zh": "如果您的智能交易系统有攻击服务器的行为，TigerWit 有权利拒绝您的智能交易系统。"},
        ...
        "swap5": {"en": "TigerWit will update swap rate quotation daily as far as possible, but there might be violent fluctuations because of unpredictable market, which means that swap rate might be subject to big changes on the very day.", "zh": "TigerWit 尽可能每日及时更新隔夜利息报价，但不排除由于无法预测的市场情况而导致的剧烈波动，隔夜利息可能在当日内有变动。"},
        ...
        "video2": {"en": "TigerWit on CCTV", "zh": "老虎金融首席策略分析师李彭为您解盘。"},
