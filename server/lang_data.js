...
module.exports = function () {
    ...
    var data = {
        ...
        "home34": { "en": "Provide excellent trading experience and protection in terms of optimizing the value of users.", "zh": "为出色的交易体验和优化用户价值提供保障" },
        ...
        "forex1": { "en": "The Foreign Exchange Market is one of the world's largest single markets. In 2013, trading volumes reached $5.3 trillion dollars. Foreign exchange rate is mainly affected by international trade, national economy and the policy and influence of investment flows. As a result, the foreign exchange market information is more transparent, liquidity is better and there are more fair prices. Transaction can be maked in two directions, Buy and sell transactions can be made 24 hours on weekdays. All the above advantages make Foreign Exchange Transaction deeply affected by large investment institutions and investors.", "zh": "外汇市场是全球最大的单一产品市场，自2013年起每天拥有超过5.3万亿美元的成交额，交易内容为两种货币之间汇率差价。由于外汇汇率主要受国际间的交易、各国经济和政策以及投资流向的影响，所以外汇交易市场的信息更透明，流通性更好，价格更公平。其具有5天24小时双向交易等特点，深受大型投资机构和投资者的喜爱。" },
        ...
        "forex7": { "en": "We provide three different kinds of leverage, 50 times, 100 times, 200 times, which makes it more flexible to meet risk control and cash management requirements..", "zh": "我们同时提供 50 倍，100 倍，200 倍三种不同的杠杆，更灵活的满足您对于风险把控，资金管理的需求。" },
        ...
        "oil1": { "en": "Crude oil, also known as 'black gold' is the main raw material in fuel and gasoline. Fuel and gasoline is one of the most important primary energy sources in the world. At present, the oil is not only the largest in the global trade of goods, it is one of the most important trading global financial assets.", "zh": "原油即石油，也称“黑色金子”，原油是燃油和汽油的主要原材料，是世界上最重要的一次能源之一。目前，原油不仅成为全球贸易中最大宗的商品，同时也是全球金融资产中最重要的交易标的物之一。" },
        ...
        "metal14": { "en": "" + companyConfig.companyNameEn + " has adopted the most extensively used and mature MT4 platform in the world and launched intelligent trading module, closely following the trend of the world financial market.", "zh": "" + companyConfig.companyNameZh + "采用全球使用最广泛的成熟的 MT4 平台，开放智能交易模块，紧贴世界金融市场潮流。" },
        ...
        "cfd13": { "en": "" + companyConfig.companyNameEn + " provides the first-hand quotation from top banks, thus helping investors achieve price discovering.", "zh": "" + companyConfig.companyNameZh + "提供来自于顶级银行的第一手数据报价，帮助投资者进行价格发现。" },
        ...
        "about2": { "en": companyConfig.companyNameEn + " founded in early 2015, is the first domestic capital market investment Internet forex trading platform.Company by the Internet or financial technology with a team thar has 15 year of experience.Abundant capital, combined with the strong ability of product innovation, the independent research and development of foreign exchange for copying documentary system and micro trading system, and provides the nearly hundred types of foreign exchange, crude oil, precious metals and CFD products, commitment to lower the difficulty of users involved in the foreign exchange market, to provide users with a fair and stable trading platform.", "zh": "" + companyConfig.companyNameZh + "成立于2015年初，是首批国内资本市场投资的互联网外汇交易服务平台。公司由互联网领域或金融科技领域15年以上经验的团队组成。凭借雄厚的资本，结合强大的产品创新能力，" + companyConfig.companyNameZh + "自主研发了复制跟单交易系统和移动端交易系统，并提供近百种外汇、原油、贵金属和指数差价合约等品种的交易服务，致力于降低用户参与外汇市场门槛，为用户提供一个公平稳定的交易平台。" },
        "about3": { "en": "Join hands with dozens of the world's top banks", "zh": "与数十家全球顶级银行合作" },
        "about4": { "en": "" + companyConfig.companyNameEn + " provides nearly 100 kinds of foreign exchange, precious metal and index trading products. One account is offered with three different kinds of leverage simultaneously. The user's order can be directly butted with dozens of the world's top banks through STP (including Bank of America, Citibank, JPMorgan Chase & Co, Barclays and Macquarie Bank), ensuring fair and transparent trading and rendering top-class trading experience for all traders. ", "zh": "" + companyConfig.companyNameZh + "提供近百种外汇、贵金属和指数交易品种，一个账户更可同时享受3种不同的交易杠杆，用户的交易订单通过STP模式直接与数十家全球顶级银行（包括：美国银行，花旗，摩根大通，巴克莱，麦格理银行等）对接，保证交易的公正与透明，为广大交易者提供一流交易体验。" },
        ...
        "about9": { "en": "Born in 1980, he is the principal owner of Happy Farm that has been popular for several years after its release and an entrepreneur building up a fortune from the overseas market. In 2012, together with his team, he rolled out the first oversea-oriented navigation web and antivirus software developed by a Chinese and also received a cordial reception from President Hu Jintao at the 90th anniversary of the Communist Youth League as an excellent youth delegate. In 2015, clash of kings was independently developed by his company ranked No.6 in the North American bestsellers' list and became an intern game achieving the greatest outcomes in the internationalization process of China's games. These outstanding achievements are gained exactly by an obscure company founded in a basement of the Beihang University by Tang who also serves as the CEO of Elex. He is a legendary figure in creating overseas market for China's games. ", "zh": "唐彬森，智明星通首席执行官，被《环球企业家》评为2010年度全国四十位“40岁以下商业精英”。2012年作为优秀青年代表在建团90周年获得胡锦涛总书记的亲切接见。2008年，成功将开心农场游戏推广到全球20多个国家，影响海外5亿人口，成为迄今为止中国出口的最有影响力的游戏。2012年，借鉴了360免费杀毒在国内的成功商业模式，在海外新兴发展中国家，带领团队推出了中国人首款面向海外的导航网站和杀毒软件服务。现已成为知名风险投资人，主要涉及的领域有：游戏、金融、消费升级等。投资具有代表性的公司：老虎外汇、老虎证券、薪人薪事等。" },
        "about10": { "en": companyConfig.companyNameEn + "’s goal is to establish financial service companies in advanced and highly regulated jurisdictions to serve local markets and we have now established set up offices in China and Australia.", "zh": companyConfig.companyNameZh + "致力于在全球受监管的区域设立金融服务公司以服务当地市场，目前已经在中国和澳大利亚设立办公室。" },
