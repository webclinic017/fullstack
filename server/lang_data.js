...
module.exports = function () {
    ...
    var data = {
        ...
        "forex1": { "en": "The Foreign Exchange Market is one of the world's largest single markets. In 2013, trading volumes reached $5.3 trillion dollars. Foreign exchange rate is mainly affected by international trade, national economy and the policy and influence of investment flows. As a result, the foreign exchange market information is more transparent, liquidity is better and there are more fair prices. Buy or sell transactions can be completed for 24 hours on weekday. All the above advantages make Foreign Exchange Transaction deeply affected by large investment institutions and investors.", "zh": "外汇市场是全球最大的单一市场之一。2013年交易量达5.3万亿美元。由于外汇汇率主要受国际间贸易、各国经济和政策以及投资流向的影响，所以外汇市场的信息更透明、流通性更好、价格更公平。其具有在工作日的所有24小时内双向交易的特点，深受大型投资机构和投资者的喜爱。" },
        ...
        "forex7": { "en": "We provide three different kinds of leverage, 50 times, 100 times, 200 times, allowing more flexibility to meet you for risk control and cash management requirements.", "zh": "我们同时提供 50 倍，100 倍，200 倍三种不同的杠杆，更灵活的满足您对于风险把控，资金管理的需求。" },
        ...
        "about_3": {"zh": "老虎外汇为客户提供独一无二的交易体验，当用户的交易订单通过专有的在线和移动交易系统交付到市场，与其他经纪商相比，老虎外汇更具优势。", "en": "TigerWit provides its clients an extraordinary user experience when trading the markets delivered through its proprietary online and mobile trading platforms. This user experience is unique and gives TigerWit an advantage when compared with other brokers."},
        ...
        "about_12": {"zh": "老虎外汇在非个性化的基础上为批发和零售客户提供一般建议。活动包括一般产品信息，研讨会/网络研讨会，通讯，一般知识和教育。", "en": "TigerWit provides general advice to wholesale or retail clients on a non-personalised basis. Activities include general product information, seminars/webinars, newsletters, general knowledge and education that is not specific to an individual’s personal situation."},
        ...
        "about_15": {"zh": "当市场开放时，每天24小时提供交易，并提供客户支持，语言，电话，聊天和电子邮件。", "en": "Trading is offered 24-hours a day when markets are open, and customer support is available, in-language, over-the-phone, via chat and email."},
        ...
        "deal38": { "en": "When the margin ratio (margin/free margin ) is below 100% on common accounts and the margin ratio is below 200% on masters accounts, system will effect forced liquidation starting from your deal with highest loss.", "zh": "A：您的订单被强制平仓了，当普通账户保证金比率（保证金/使用的保证金）低于100%，高手帐户的保证金比率（保证金/使用的保证金）低于200%，系统会从您损失最大的订单开始平仓的。" },
