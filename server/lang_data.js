...
module.exports = function () {
    ...
    var data = {
        ...
        "openAccount": {"en": "Open an account", "zh": "开立真实帐户"},
        ...
        "foot_14": {"zh": "您访问本网站，即表示您同意和理解本网站所附的条款和条件和网站上的所有资料。对于TigerWit Financial Services Limited的客户，本公司保留在不通知您的情况下随时修改这些条款和条件的权利。所以您有责任定期检查这些条款和条件。如果您在修改之后继续使用本网站，即构成您接受修改。", "en": "By accessing this website, you signify your agreement with and understanding of the following Terms and Conditions pertaining to both this site and any material at it. For clients of TigerWit Financial Services Limited, the Company reserves the right to change these Terms and Conditions at any time without notice to you. You are therefore responsible for regularly reviewing these Terms and Conditions. Continued use of this site following any such changes shall constitute your acceptance of such changes."},
        ...
        "foot_34": {"zh": "TigerWit Financial Services Limited的客户访问本网站，即代表您同意不考虑法律冲突原则。巴哈马法律将适用于所有与使用本网站有关的事宜。如有任何争议，您同意巴哈马具有排他性司法管辖权。在任何条款和条件无法执行的情况下，其余条款和条件不受损害，无法执行的条款和条件应由此类最接近无法执行条款或条件潜在意图的可执行条款和条件所替换。本协议并不替代或以任何方式修改您与本公司签署的任何其他协议。", "en": "For clients of TigerWit Financial Services Limited, by accessing this site, you agree that the laws of The Bahamas, without regard to Conflict of Laws principles thereof, will apply to all matters relating to the use of this site. In case of a dispute, you agree to the exclusive jurisdiction of The Bahamas. In the event any of the Terms and Conditions shall be held to be unenforceable, the remaining Terms and Conditions shall be unimpaired and the unenforceable Term or Condition shall be replaced by such enforceable Term or Condition as comes closest to the intention underlying the unenforceable Term or Condition. This Agreement does not replace or in any way amend any other agreement you have entered into with the Company."},
        "foot_35": {"zh": "老虎外汇受巴哈马证券交易委员会（SCB)的授权和监管，监管号：SIA-F185。", "en": "TigerWit regulated and licenced by the Securities Commision of The Bahamas. Financial Services Licence number: SIA-F185."},
        ...
        "oil1": { "en": "Fuel and gasoline are the most important energy sources in the world.  At present, oil is not only the largest in the global trade of goods, it is one of the most important global financial assets.", "zh": "原油即石油，也称“黑色金子”，原油是燃油和汽油的主要原材料，是世界上最重要的一次能源之一。目前，原油不仅成为全球贸易中最大宗的商品，同时也是全球金融资产中最重要的交易标的物之一。" },
